...
<!-- generated with COPASI 4.16.117+ (Source) (http://www.copasi.org) at 2016-08-24 17:19:26 UTC -->
  ...
  <rdf:Description rdf:about="#ModelValue_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <Expression>
          (1-&lt;CN=Root,Model=New Model,Vector=Values[x],Reference=InitialValue>)^2+100*(&lt;CN=Root,Model=New Model,Vector=Values[y],Reference=InitialValue>-&lt;CN=Root,Model=New Model,Vector=Values[x],Reference=InitialValue>^2)^2
        </Expression>
      </ModelValue>
    </ListOfModelValues>
