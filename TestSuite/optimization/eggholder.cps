...
<!-- generated with COPASI 4.16.122+ (Source) (http://www.copasi.org) at 2016-09-05 11:49:34 UTC -->
...
minimum at 512, 404.2319 = -959.6407
    </Comment>
    <ListOfModelValues>
  ...
  <rdf:Description rdf:about="#ModelValue_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <Expression>
          -1*(&lt;CN=Root,Model=New Model,Vector=Values[y],Reference=InitialValue>+47)*sin(sqrt(abs(&lt;CN=Root,Model=New Model,Vector=Values[x],Reference=InitialValue>/2+(&lt;CN=Root,Model=New Model,Vector=Values[y],Reference=InitialValue>+47))))-&lt;CN=Root,Model=New Model,Vector=Values[x],Reference=InitialValue>*sin(sqrt(abs(&lt;CN=Root,Model=New Model,Vector=Values[x],Reference=InitialValue>-(&lt;CN=Root,Model=New Model,Vector=Values[y],Reference=InitialValue>+47))))
        </Expression>
      </ModelValue>
    </ListOfModelValues>
    <ListOfModelParameterSets activeSet="ModelParameterSet_0">
      <ModelParameterSet key="ModelParameterSet_0" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[f]" value="-25.46033718528631" type="ModelValue" simulationType="assignment"/>
        </ModelParameterGroup>
