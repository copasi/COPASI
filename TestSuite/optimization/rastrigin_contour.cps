...
<!-- generated with COPASI 4.16.117+ (Source) (http://www.copasi.org) at 2016-08-24 17:21:01 UTC -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="16" versionDevel="117" copasiSourcesModified="1">
  <Model key="Model_7" name="New Model" simulationType="time" timeUnit="s" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+23">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_7">
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_5" name="x" simulationType="fixed">
        <MiriamAnnotation>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_4">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_3" name="f" simulationType="assignment">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <Expression>
          20+(&lt;CN=Root,Model=New Model,Vector=Values[x],Reference=InitialValue>^2-10*cos(2*pi*&lt;CN=Root,Model=New Model,Vector=Values[x],Reference=InitialValue>))+(&lt;CN=Root,Model=New Model,Vector=Values[y],Reference=InitialValue>^2-10*cos(2*pi*&lt;CN=Root,Model=New Model,Vector=Values[y],Reference=InitialValue>))
        </Expression>
      </ModelValue>
    </ListOfModelValues>
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[f]" value="0" type="ModelValue" simulationType="assignment"/>
        </ModelParameterGroup>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_18" name="Optimization" type="optimization" scheduled="false" updateModel="false">
      ...
      <Method name="Levenberg - Marquardt" type="LevenbergMarquardt">
        ...
        <Parameter name="Modulation" type="float" value="1e-06"/>
      </Method>
    </Task>
