...
<!-- generated with COPASI 4.38 (Build 268) (http://www.copasi.org) at 2022-12-14T15:33:46Z -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="38" versionDevel="268" copasiSourcesModified="0">
  <Model key="Model_1" name="Rastrigin's function" simulationType="time" timeUnit="s" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.0221417899999999e+23">
    <MiriamAnnotation>
<rdf:RDF
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_7">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_6" name="Rastrigin's function" simulationType="assignment" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#ModelParameterSet_1">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_20" name="Scan" type="scan" scheduled="true" updateModel="false">
      <Report reference="Report_8" target="RastriginFunction.txt" append="1" confirmOverwrite="0"/>
      <Problem>
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          ...
          <ParameterGroup name="OptimizationItem">
            ...
            <Parameter name="StartValue" type="float" value="-0.93046122112554985"/>
            <Parameter name="UpperBound" type="cn" value="5.12"/>
          </ParameterGroup>
        </ParameterGroup>
