...
<!-- generated with COPASI 4.38 (Build 268) (http://www.copasi.org) at 2022-12-14T15:31:50Z -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="38" versionDevel="268" copasiSourcesModified="0">
  <Model key="Model_1" name="Himmelblau function" simulationType="time" timeUnit="s" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.0221417899999999e+23">
    <MiriamAnnotation>
<rdf:RDF
...
<p>First defined by:  Himmelblau, D. (1972) <i>Applied nonlinear programming</i>, McGraw-Hill.</p><p style="font-size:small"><b>CC0 1.0 Universal</b>: To the extent possible under law, all copyright and related or neighbouring rights to this encoded model have been dedicated to the public domain worldwide. You can copy, modify, distribute and perform the work, even for commercial purposes, all without asking permission. Please refer to <a href="http://creativecommons.org/publicdomain/zero/1.0/" title="Creative Commons CC0">CC0 Public Domain Dedication</a> for more information.</p></body>
    </Comment>
    <ListOfModelValues>
      <ModelValue key="ModelValue_6" name="x1" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_7">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_4" name="Himmelblau function" simulationType="assignment" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#ModelParameterSet_1">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_29" name="Scan" type="scan" scheduled="true" updateModel="false">
      <Report reference="Report_11" target="HimmelblauFunction.txt" append="1" confirmOverwrite="0"/>
      <Problem>
  ...
  <ListOfPlots>
    ...
    <PlotSpecification name="Create New" type="Plot2D" active="0" taskTypes="">
      <Parameter name="log X" type="bool" value="0"/>
