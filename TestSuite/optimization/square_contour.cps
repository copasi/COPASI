...
<!-- generated with COPASI 4.17.135+ (Source) (http://www.copasi.org) at 2017-03-14 10:11:31 UTC -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="17" versionDevel="135" copasiSourcesModified="1">
  <Model key="Model_33" name="New Model" simulationType="time" timeUnit="s" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+23">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_33">
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_35" name="x" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_35">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_34" name="y" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <Expression>
          (1+&lt;CN=Root,Model=New Model,Vector=Values[x],Reference=InitialValue>)^2+10*(1+&lt;CN=Root,Model=New Model,Vector=Values[y],Reference=InitialValue>)^2+1
        </Expression>
      </ModelValue>
    </ListOfModelValues>
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[f]" value="12" type="ModelValue" simulationType="assignment"/>
        </ModelParameterGroup>
  ...
  <ListOfTasks>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            <Parameter name="Maximum" type="float" value="5.12"/>
            <Parameter name="Minimum" type="float" value="-5.12"/>
            <Parameter name="Number of steps" type="unsignedInteger" value="30"/>
            <Parameter name="Object" type="cn" value="CN=Root,Model=New Model,Vector=Values[x],Reference=InitialValue"/>
          ...
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Minimum" type="float" value="-5.12"/>
            <Parameter name="Number of steps" type="unsignedInteger" value="30"/>
            <Parameter name="Object" type="cn" value="CN=Root,Model=New Model,Vector=Values[y],Reference=InitialValue"/>
            <Parameter name="Type" type="unsignedInteger" value="1"/>
            <Parameter name="log" type="bool" value="0"/>
          </ParameterGroup>
        </ParameterGroup>
    ...
    <Task key="Task_22" name="Optimization" type="optimization" scheduled="true" updateModel="false">
      <Report reference="Report_11" target="test" append="1" confirmOverwrite="0"/>
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="OptimizationItem">
            ...
            <Parameter name="StartValue" type="float" value="5.00394"/>
          ...
          <ParameterGroup name="OptimizationItem">
            ...
            <Parameter name="StartValue" type="float" value="3.205067188293922"/>
            <Parameter name="UpperBound" type="cn" value="5.12"/>
          </ParameterGroup>
        </ParameterGroup>
  ...
  <ListOfReports>
    ...
    <Report key="Report_11" name="Empty" taskType="unset" separator="&#x09;" precision="6">
      <Comment>
  ...
  <ListOfPlots>
    ...
    <PlotSpecification name="contour" type="Plot2D" active="1">
      <Parameter name="log X" type="bool" value="0"/>
      ...
      <ListOfPlotItems>
        <PlotItem name="Values[y].InitialValue/Values[f].InitialValue|Values[x].InitialValue" type="Spectogram">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=New Model,Vector=Values[x],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=New Model,Vector=Values[y],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Model=New Model,Vector=Values[f],Reference=InitialValue"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
