...
<!-- generated with COPASI 4.18 (Build 136) (http://www.copasi.org) at 2016-12-14 18:14:09 UTC -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="18" versionDevel="136" copasiSourcesModified="0">
  <Model key="Model_21" name="Schaffer F7(10) function" simulationType="time" timeUnit="s" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic" avogadroConstant="6.02214179e+23">
    <MiriamAnnotation>
<rdf:RDF
...
<p>Defined in: Schaffer, J.D. (1985) <i>Some experiments in machine learning using vector evaluated genetic algorithms</i> PhD Thesis, Vanderbilt University, Nashville, TN (USA).</p>
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_21" name="x1" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_21">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_22" name="x2" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_23">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_24" name="x3" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_25" name="x4" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_26" name="x5" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_27" name="x6" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_28" name="x7" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_29" name="x8" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_30" name="x9" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_31" name="x10" simulationType="fixed">
      </ModelValue>
    </ListOfModelValues>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_24" name="Scan" type="scan" scheduled="true" updateModel="false">
      <Report reference="Report_18" target="SchafferF7_10Function.txt" append="1" confirmOverwrite="0"/>
      <Problem>
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="OptimizationItem">
            ...
            <Parameter name="StartValue" type="float" value="-43.91720503830375"/>
