...
<!-- generated with COPASI 4.0 (Debug 18++) (http://www.copasi.org) at 2006-08-30 13:57:09 UTC -->
...
<p>Dummy testmodel. K3 should always be [B]+2.0.</p>
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_5" name="K1" status="assignment" stateVariable="">
        <MathML>
          <Text>
            &lt;CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[B],Reference=Concentration&gt;/&lt;CN=Root,Model=New Model,Vector=Compartments[compartment],Reference=Volume&gt;-0.1
          </Text>
        </MathML>
      </ModelValue>
      <ModelValue key="ModelValue_6" name="K2" status="assignment" stateVariable="">
        <MathML>
          <Text>
            0.5*&lt;CN=Root,Model=New Model,Vector=Values[K5],Reference=Value&gt;
          </Text>
        </MathML>
      </ModelValue>
      <ModelValue key="ModelValue_7" name="K3" status="assignment" stateVariable="">
        <MathML>
          <Text>
      ...
      <ModelValue key="ModelValue_8" name="K4" status="assignment" stateVariable="">
        <MathML>
          <Text>
            2*&lt;CN=Root,Model=New Model,Vector=Values[K1],Reference=Value&gt;+1.2
          </Text>
        </MathML>
      </ModelValue>
    ...
    <ListOfReactions>
      <Reaction key="Reaction_2" name="reaction" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_2" name="v" value="0.1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_3" name="reaction_1" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_3" name="v" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_6">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
    ...
    <InitialState type="initialState">
      0 1.2044283e+20 6.022141500000002e+21 0 0 0 0 0 2 2
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_2" name="Time-Course" type="timeCourse" scheduled="false" updateModel="false">
      <Report reference="Report_11" target="assignment-Parameter3.CSV" append="0"/>
      <Problem>
  ...
  <ListOfReports>
    ...
    <Report key="Report_11" name="Concentrations table with time" taskType="timeCourse" separator="&#x09;" precision="6">
      <Comment>
        <body xmlns="http://www.w3.org/1999/xhtml">
          A table of the variable metabolite concentrations and time. It does not contain the concentrations of fixed metabolites.
        </body>
      </Comment>
      <Table printTitle="1">
        ...
        <Object cn="CN=Root,Model=New Model,Vector=Values[K2],Reference=Value"/>
        <Object cn="CN=Root,Model=New Model,Vector=Values[K3],Reference=Value"/>
        <Object cn="CN=Root,Model=New Model,Vector=Values[K4],Reference=Value"/>
        <Object cn="CN=Root,Model=New Model,Vector=Values[K5],Reference=Value"/>
      </Table>
    </Report>
  </ListOfReports>
  <ListOfPlots>
