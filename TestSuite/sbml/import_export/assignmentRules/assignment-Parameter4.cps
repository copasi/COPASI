...
<!-- generated with COPASI 4.0 (Debug 18++) (http://www.copasi.org) at 2006-08-30 11:16:23 UTC -->
<COPASI xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.copasi.org/static/schema.xsd" versionMajor="0" versionMinor="1">
  ...
  <Model key="Model_0" name="New Model" timeUnit="s" volumeUnit="ml" quantityUnit="mMol" type="deterministic">
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_5" name="A" compartment="Compartment_1" status="reactions"/>
      <Metabolite key="Metabolite_4" name="B" compartment="Compartment_1" status="reactions"/>
      <Metabolite key="Metabolite_3" name="C" compartment="Compartment_1" status="reactions"/>
    </ListOfMetabolites>
    <ListOfModelValues>
    ...
    <ListOfReactions>
      <Reaction key="Reaction_3" name="reaction" reversible="false">
        <ListOfProducts>
          <Product metabolite="Metabolite_5" stoichiometry="1"/>
        </ListOfProducts>
        <ListOfConstants>
          <Constant key="Parameter_168" name="v" value="0.1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_2" name="reaction_1" reversible="false">
        <ListOfSubstrates>
        ...
        <ListOfConstants>
          <Constant key="Parameter_167" name="k1" value="0.1"/>
        </ListOfConstants>
    ...
    <InitialState type="initialState">
      0 6.022141500000001e+19 3.011070750000001e+21 0 0 1
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_1" name="Parameter Estimation" type="parameterFitting" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <Parameter name="Time-Course" type="key" value="Task_4"/>
        <ParameterGroup name="OptimizationItemList">
        </ParameterGroup>
        <ParameterGroup name="OptimizationConstraintList">
        </ParameterGroup>
    ...
    <Task key="Task_0" name="Metabolic Control Analysis" type="metabolicControlAnalysis" scheduled="false" updateModel="false">
    ...
    <Task key="Task_10" name="Lyapunov Exponents" type="lyapunovExponents" scheduled="false" updateModel="false">
    ...
    <Task key="Task_13" name="Time Scale Separation" type="timeScaleSeparation" scheduled="false" updateModel="false">
      <Problem>
      </Problem>
