...
<!-- generated with COPASI 4.0 (Debug 18++) (http://www.copasi.org) at 2006-08-30 10:59:16 UTC -->
<COPASI xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.copasi.org/static/schema.xsd" versionMajor="0" versionMinor="1">
  ...
  <Model key="Model_0" name="New Model" timeUnit="s" volumeUnit="ml" quantityUnit="mMol" type="deterministic">
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_1" name="K1" status="assignment" stateVariable="">
        <MathML>
          <Text>
            2*&lt;CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[B],Reference=Concentration&gt;
          </Text>
        </MathML>
      </ModelValue>
      <ModelValue key="ModelValue_2" name="K2" status="assignment" stateVariable="">
        <MathML>
          <Text>
      ...
      <ModelValue key="ModelValue_3" name="K3" status="assignment" stateVariable="">
        <MathML>
          <Text>
      ...
      <ModelValue key="ModelValue_4" name="K4" status="assignment" stateVariable="">
        <MathML>
          <Text>
            0.5*&lt;CN=Root,Model=New Model,Vector=Values[K1],Reference=Value&gt;
          </Text>
        </MathML>
      </ModelValue>
      <ModelValue key="ModelValue_5" name="K5" status="fixed" stateVariable=""/>
    </ListOfModelValues>
    <ListOfReactions>
    ...
    <InitialState type="initialState">
      0 6.022141500000001e+19 3.011070750000001e+21 0 0 0 0 0 2 1
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_6" name="Time-Course" type="timeCourse" scheduled="false" updateModel="false">
      <Problem>
    ...
    <Task key="Task_3" name="Parameter Estimation" type="parameterFitting" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <Parameter name="Time-Course" type="key" value="Task_6"/>
        <ParameterGroup name="OptimizationItemList">
        </ParameterGroup>
        <ParameterGroup name="OptimizationConstraintList">
        </ParameterGroup>
