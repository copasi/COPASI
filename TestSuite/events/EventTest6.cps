...
<!-- generated with COPASI 4.5.31 (development) (http://www.copasi.org) at 2010-03-16 17:30:55 UTC -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="1" versionMinor="0" versionDevel="31">
  <ListOfFunctions>
    ...
    <Function key="Function_126" name="add" type="UserDefined" reversible="unspecified">
      <Expression>
        x+y
      </Expression>
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_887" name="x" order="0" role="variable"/>
        <ParameterDescription key="FunctionParameter_886" name="y" order="1" role="variable"/>
      </ListOfParameterDescriptions>
    </Function>
  </ListOfFunctions>
  <Model key="Model_1" name="Event Test 6" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="mol" type="deterministic">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_1">
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_2" name="S1" simulationType="reactions" compartment="Compartment_0">
        <InitialExpression>
      ...
      <Metabolite key="Metabolite_3" name="S2" simulationType="reactions" compartment="Compartment_0">
      </Metabolite>
      <Metabolite key="Metabolite_1" name="S3" simulationType="reactions" compartment="Compartment_0">
      </Metabolite>
    </ListOfMetabolites>
    <ListOfModelValues>
      ...
      <ModelValue key="ModelValue_8" name="p1" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_9" name="Event Time 1" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_9">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_10" name="Event Time 2" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_11" name="Event Counter" simulationType="fixed">
      </ModelValue>
    </ListOfModelValues>
    <ListOfReactions>
      <Reaction key="Reaction_71" name="reaction1" reversible="false">
        <ListOfSubstrates>
        ...
        <ListOfConstants>
          <Constant key="Parameter_622" name="k1" value="1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_63" name="reaction2" reversible="false">
        <ListOfSubstrates>
        ...
        <ListOfConstants>
          <Constant key="Parameter_679" name="k1" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
    ...
    <ListOfEvents>
      ...
      <Event key="Event_2" name="Event 2" order="2">
        <TriggerExpression>
    ...
    <InitialState type="initialState">
      0 6.0221415e+23 1.2044283e+24 6.0221415e+23 0.75 0.25 0.8 0.2 0.5 0 0 0 1 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_19" name="Time-Course" type="timeCourse" scheduled="true" updateModel="false">
      <Report reference="Report_10" target="EventTest6.1.txt" append="0"/>
      <Problem>
  ...
  <ListOfReports>
    ...
    <Report key="Report_10" name="Event " taskType="timeCourse" separator="&#x09;" precision="6">
      <Comment>
        <body xmlns="http://www.w3.org/1999/xhtml">
  ...
  <SBMLReference file="00754-sbml-l2v2.xml">
    ...
    <SBMLMap SBMLid="add" COPASIkey="Function_126"/>
    ...
    <SBMLMap SBMLid="reaction1" COPASIkey="Reaction_71"/>
    <SBMLMap SBMLid="reaction2" COPASIkey="Reaction_63"/>
  </SBMLReference>
</COPASI>
