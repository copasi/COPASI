...
<!-- generated with COPASI 4.12.67+ (Debug) (http://www.copasi.org) at 2014-03-19 17:52:07 UTC -->
<?oxygen RNGSchema="http://www.copasi.org/static/schema/CopasiML.rng" type="xml"?>
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="12" versionDevel="67" copasiSourcesModified="1">
  <ListOfFunctions>
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4065" name="k1" value="0.1"/>
        </ListOfConstants>
    ...
    <ListOfEvents>
      <Event key="Event_0" name="event_1" delayAssignment="false" fireAtInitialTime="0" persistentTrigger="0">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Event_0">
    <dcterms:created>
      ...
      <Event key="Event_1" name="event_2" delayAssignment="false" fireAtInitialTime="0" persistentTrigger="0">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_11" name="Time-Course" type="timeCourse" scheduled="true" updateModel="false">
      <Report reference="Report_17" target="EventTest23.1.txt" append="0" confirmOverwrite="0"/>
      <Problem>
