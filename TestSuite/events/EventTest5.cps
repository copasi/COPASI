...
<!-- generated with COPASI 4.5.30 (Debug) (http://www.copasi.org) at 2009-07-10 01:21:55 UTC -->
<COPASI xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.copasi.org/static/schema.xsd" versionMajor="1" versionMinor="0" versionDevel="30">
  ...
  <Model key="Model_0" name="New Model" timeUnit="s" volumeUnit="ml" areaUnit="m²" lengthUnit="m" quantityUnit="mmol" type="deterministic">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_0">
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_2" name="A" simulationType="reactions" compartment="Compartment_1">
        <MiriamAnnotation>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_3">
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_7" name="Event Time 1" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_7">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_6" name="Event Counter1" simulationType="fixed">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_6">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_3" name="Event Counter 2" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_1" name="Event Time 2" simulationType="fixed">
      </ModelValue>
    </ListOfModelValues>
    <ListOfReactions>
      <Reaction key="Reaction_1" name="1" reversible="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_587" name="k1" value="0.1"/>
        </ListOfConstants>
    ...
    <ListOfEvents>
      <Event key="Event_2" name="Event 1" order="1" delayAssignment="true">
        <TriggerExpression>
        ...
        <ListOfAssignments>
          ...
          <Assignment targetKey="ModelValue_6">
            <Expression>
              &lt;CN=Root,Model=New Model,Vector=Values[Event Counter1],Reference=Value&gt;+1
            </Expression>
          </Assignment>
        </ListOfAssignments>
      </Event>
      <Event key="Event_3" name="Event 2" order="2" delayAssignment="true">
        <TriggerExpression>
          &lt;CN=Root,Model=New Model,Vector=Values[Event Counter1],Reference=Value&gt; gt 1
        </TriggerExpression>
        <ListOfAssignments>
    ...
    <InitialState type="initialState">
      0 6.022141500000001e+020 0 0 0 0 0 1
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_9" name="Time-Course" type="timeCourse" scheduled="true" updateModel="false">
      <Report reference="Report_6" target="EventTest5.1.txt" append="0"/>
      <Problem>
  ...
  <ListOfReports>
    ...
    <Report key="Report_6" name="Events" taskType="timeCourse" separator="&#x09;" precision="6">
      <Comment>
        <body xmlns="http://www.w3.org/1999/xhtml">
      ...
      <Table printTitle="1">
        ...
        <Object cn="CN=Root,Model=New Model,Vector=Values[Event Counter1],Reference=Value"/>
    ...
    <PlotSpecification name="Concentrations, Volumes, and Global Quantity Values" type="Plot2D" active="1">
      ...
      <ListOfPlotItems>
        ...
        <PlotItem name="Counter1" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=New Model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=New Model,Vector=Values[Event Counter1],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
