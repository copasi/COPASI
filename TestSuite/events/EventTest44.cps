...
<!-- generated with COPASI 4.41.280+ (Debug) (http://www.copasi.org) at 2023-09-06T15:45:06Z -->
<?oxygen RNGSchema="http://www.copasi.org/static/schema/CopasiML.rng" type="xml"?>
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="41" versionDevel="280" copasiSourcesModified="1">
  <ListOfFunctions>
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_0">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2023-09-06T15:07:09Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
    <dcterms:creator>
      <rdf:Description>
        <vCard:EMAIL>shoops@copasi.org</vCard:EMAIL>
        <vCard:N>
          <rdf:Description>
        ...
        <vCard:ORG>
          <rdf:Description>
            <vCard:Orgname>COPASI</vCard:Orgname>
          </rdf:Description>
        </vCard:ORG>
      </rdf:Description>
    </dcterms:creator>
...
<rdf:Description rdf:about="#Reaction_1">
        ...
        <ListOfConstants>
          <Constant key="Parameter_8520" name="k1" value="0.1"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#Event_0">
        ...
        <ListOfAssignments>
          <Assignment target="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[A],Reference=ParticleNumber">
            <Expression>
              1e6
            </Expression>
          </Assignment>
...
<rdf:Description rdf:about="#ModelParameterSet_0">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_12" name="Time-Course" type="timeCourse" scheduled="true" updateModel="false">
      <Report reference="Report_22" target="EventTest44.1.txt" append="0" confirmOverwrite="0"/>
      <Problem>
  ...
  <ListOfReports>
    ...
    <Report key="Report_22" name="Time, Particle Numbers, Volumes, and Global Quantity Values" taskType="timeCourse" separator="&#x09;" precision="6">
      <Comment>
