...
<!-- generated with COPASI 4.23.178+ (Debug) (http://www.copasi.org) at 2018-03-28 21:19:21 UTC -->
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_0">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2018-03-28T17:08:10Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_0" name="Counter" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_0">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2018-03-28T17:08:20Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Event_0">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2018-03-28T17:08:33Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
        ...
        <TriggerExpression>
          &lt;CN=Root,Model=New Model,Reference=Time>%3 > 1
        </TriggerExpression>
        <ListOfAssignments>
          <Assignment targetKey="ModelValue_0">
            <Expression>
              &lt;CN=Root,Model=New Model,Vector=Values[Counter],Reference=Value>+1
            </Expression>
          </Assignment>
        </ListOfAssignments>
      </Event>
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_0">
      <ModelParameterSet key="ModelParameterSet_0" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[Counter]" value="0" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_11" name="Time-Course" type="timeCourse" scheduled="true" updateModel="false">
      <Report reference="Report_18" target="EventTest32.1.txt" append="0" confirmOverwrite="0"/>
      <Problem>
  ...
  <ListOfReports>
    ...
    <Report key="Report_18" name="Time, Concentrations, Volumes, and Global Quantity Values" taskType="timeCourse" separator="&#x09;" precision="6">
      ...
      <Table printTitle="1">
        ...
        <Object cn="CN=Root,Model=New Model,Vector=Values[Counter],Reference=Value"/>
      </Table>
    </Report>
  </ListOfReports>
  <ListOfPlots>
      ...
      <ListOfPlotItems>
        <PlotItem name="Values[Counter]" type="Curve2D">
          ...
          <ListOfChannels>
            ...
            <ChannelSpec cn="CN=Root,Model=New Model,Vector=Values[Counter],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
