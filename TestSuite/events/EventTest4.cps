...
<!-- generated with COPASI 4.5.30 (Debug) (http://www.copasi.org) at 2009-07-09 02:44:36 UTC -->
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Metabolite_1">
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_0" name="Event Time" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_1" name="Event Counter" simulationType="fixed">
      </ModelValue>
    </ListOfModelValues>
    <ListOfReactions>
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_39" name="k1" value="0.1"/>
        </ListOfConstants>
    ...
    <InitialState type="initialState">
      0 6.022141500000001e+020 0 0 0 1
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_9" name="Time-Course" type="timeCourse" scheduled="false" updateModel="false">
      <Report reference="Report_8" target="EventTest4.1.txt" append="0"/>
      <Problem>
