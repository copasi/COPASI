...
<!-- generated with COPASI 4.5.31 (development) (http://www.copasi.org) at 2010-03-16 17:30:36 UTC -->
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_1">
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_3" name="A" simulationType="reactions" compartment="Compartment_0">
        <MiriamAnnotation>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_2">
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_7" name="Event Time" simulationType="fixed">
      </ModelValue>
      <ModelValue key="ModelValue_6" name="Event Counter" simulationType="fixed">
      </ModelValue>
    </ListOfModelValues>
    <ListOfReactions>
      <Reaction key="Reaction_71" name="1" reversible="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_71">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_694" name="k1" value="0.1"/>
        </ListOfConstants>
    ...
    <InitialState type="initialState">
      0 6.022141500000001e+20 0 0 0 1 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_18" name="Time-Course" type="timeCourse" scheduled="true" updateModel="false">
      <Report reference="Report_9" target="EventTest4.1.txt" append="0"/>
      <Problem>
    ...
    <Task key="Task_11" name="Lyapunov Exponents" type="lyapunovExponents" scheduled="false" updateModel="false">
  ...
  <ListOfReports>
    ...
    <Report key="Report_9" name="Events" taskType="timeCourse" separator="&#x09;" precision="6">
      <Comment>
        <body xmlns="http://www.w3.org/1999/xhtml">
