...
static void stoda( C_INT32 neq, C_FLOAT64 *y, void (*f)() );
static void endstoda( void );
static void prja( C_INT32 neq, C_FLOAT64 *y, void (*f)() );
static void correction( C_INT32 neq, C_FLOAT64 *y, void (*f)(), C_INT32 *corflag,
			C_FLOAT64 pnorm, C_FLOAT64 *del, C_FLOAT64 *delp,
			C_FLOAT64 *told, C_INT32 *ncf, C_FLOAT64 *rh, C_INT32 *m );
static void resetcoeff( void );
static void methodswitch( C_FLOAT64 dsm, C_FLOAT64 pnorm, C_FLOAT64 *pdh, C_FLOAT64 *rh );
...
C_FLOAT64 lsoda_ddot( n, dx, incx, dy, incy )
    C_FLOAT64 *dx, *dy;
C_INT32 n, incx, incy;
/*
...
void lsoda_daxpy( n, da, dx, incx, dy, incy )
    C_FLOAT64 da, *dx, *dy;
C_INT32 n, incx, incy;
/*
   Purpose : To compute
...
void lsoda_dgesl( a, n, ipvt, b, job )
    C_FLOAT64 **a, *b;
C_INT32 n, *ipvt, job;
/*
...
C_INT32 lsoda_idamax( n, dx, incx )
    C_FLOAT64 *dx;
C_INT32 n, incx;
...
void lsoda_dgefa( a, n, ipvt, info )
    C_FLOAT64 **a;
C_INT32 n, *ipvt, *info;
/*
...
void lsoda( f, neq, y, t, tout, itol, rtol, atol, itask, istate,
    ...
    void (*f)();
C_INT32 neq, itol, itask, *istate, iopt, jt;
C_INT32 iwork1, iwork2, iwork5, iwork6, iwork7, iwork8, iwork9;
C_FLOAT64 *y, *t, tout, *rtol, *atol;
C_FLOAT64 rwork1, rwork5, rwork6, rwork7;
...
*/
        stoda( neq, y, f );
/*      in Win32 systems it seems that a sleep call is needed to yield some control? */
/*      Sleep( 0 ); */
/*
