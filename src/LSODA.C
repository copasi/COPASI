...
static double **yh=(double**)NULL, **wm=(double**)NULL, 
              *ewt=(double*)NULL, *savf=(double*)NULL, 
			  *acor=(double*)NULL;
static int *ipvt=(int*)NULL;
...
double lsoda_ddot( n, dx, incx, dy, incy )
double *dx, *dy;
int n, incx, incy;
/*
...
int n, *ipvt, *info;
/*
   Purpose : lsoda_dgefa factors a double matrix by Gaussian elimination.
...
{
   int i, ier, j;
   /*int lenp, ml3, meb1, meband, mband, mba, j1, jj, i1, i2, ii, np1;*/
