...
<!-- generated with COPASI 4.30 (Build 235) (http://www.copasi.org) at 2020-12-27T11:54:51Z -->
...
<dcterms:W3CDTF>2020-12-27T02:59:34Z</dcterms:W3CDTF>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_26" name="Scan" type="scan" scheduled="true" updateModel="false">
      <Report reference="Report_11" target="3enzyme_ss.out" append="1" confirmOverwrite="0"/>
      <Problem>
    ...
    <Task key="Task_23" name="Parameter Estimation" type="parameterFitting" scheduled="false" updateModel="false">
      ...
      <Method name="Scatter Search" type="ScatterSearch">
        <Parameter name="Log Verbosity" type="unsignedInteger" value="0"/>
        <Parameter name="Number of Iterations" type="unsignedInteger" value="50"/>
        <Parameter name="Random Number Generator" type="unsignedInteger" value="1"/>
        <Parameter name="Seed" type="unsignedInteger" value="0"/>
