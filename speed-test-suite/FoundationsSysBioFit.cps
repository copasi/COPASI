...
<!-- generated with COPASI 4.30 (Build 235) (http://www.copasi.org) at 2020-12-25T15:17:00Z -->
...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
    ...
    <Function key="Function_4190" name="MM(expl. enzyme)" type="UserDefined" reversible="true">
      <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Function_4190">
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2020-12-22T20:36:54Z</dcterms:W3CDTF>
      ...
      <ListOfParameterDescriptions>
        ...
        <ParameterDescription key="FunctionParameter_20681" name="P" order="1" role="product"/>
        <ParameterDescription key="FunctionParameter_25141" name="E" order="2" role="modifier"/>
    ...
    <Function key="Function_4191" name="Prot synth" type="UserDefined" reversible="false">
      <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Function_4191">
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2020-12-22T20:36:54Z</dcterms:W3CDTF>
</rdf:Description>
    ...
    <Function key="Function_4192" name="mRNA synthesis w/ repressor &amp; inducer" type="UserDefined" reversible="false">
      <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Function_4192">
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2020-12-22T20:36:54Z</dcterms:W3CDTF>
</rdf:Description>
  ...
  <rdf:Description rdf:about="#Reaction_3763">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5723" name="kcat" value="0.0912698"/>
          <Constant key="Parameter_5611" name="Keq" value="1"/>
          <Constant key="Parameter_5610" name="Kms" value="8.20009e+10"/>
          <Constant key="Parameter_5699" name="Kmp" value="18606"/>
        </ListOfConstants>
        <KineticLaw function="Function_4190" unitType="Default" scalingCompartment="CN=Root,Model=3-enzyme linear pathway with gene expression,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_264">
              <SourceParameter reference="Metabolite_365"/>
            </CallParameter>
            <CallParameter functionParameter="FunctionParameter_20681">
              <SourceParameter reference="Metabolite_364"/>
            </CallParameter>
            <CallParameter functionParameter="FunctionParameter_25141">
            ...
            <CallParameter functionParameter="FunctionParameter_25758">
              <SourceParameter reference="Parameter_5611"/>
            </CallParameter>
            <CallParameter functionParameter="FunctionParameter_25759">
              <SourceParameter reference="Parameter_5610"/>
            </CallParameter>
...
<dcterms:W3CDTF>2020-12-22T20:36:54Z</dcterms:W3CDTF>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5722" name="kcat" value="252974"/>
          <Constant key="Parameter_5609" name="Keq" value="1"/>
          <Constant key="Parameter_5608" name="Kms" value="0.00400667"/>
          <Constant key="Parameter_5729" name="Kmp" value="0.633694"/>
        </ListOfConstants>
        <KineticLaw function="Function_4190" unitType="Default" scalingCompartment="CN=Root,Model=3-enzyme linear pathway with gene expression,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_264">
            ...
            <CallParameter functionParameter="FunctionParameter_25758">
              <SourceParameter reference="Parameter_5609"/>
            </CallParameter>
            <CallParameter functionParameter="FunctionParameter_25759">
...
<dcterms:W3CDTF>2020-12-22T20:36:54Z</dcterms:W3CDTF>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5473" name="kcat" value="3.48331e-12"/>
          <Constant key="Parameter_5472" name="Keq" value="1"/>
          <Constant key="Parameter_5457" name="Kms" value="188640"/>
          <Constant key="Parameter_5451" name="Kmp" value="6.37804e+10"/>
        </ListOfConstants>
        <KineticLaw function="Function_4190" unitType="Default" scalingCompartment="CN=Root,Model=3-enzyme linear pathway with gene expression,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_264">
...
<dcterms:W3CDTF>2020-12-22T20:36:54Z</dcterms:W3CDTF>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5456" name="V" value="0.000145861"/>
          <Constant key="Parameter_5454" name="K" value="2.92705e-07"/>
        </ListOfConstants>
        <KineticLaw function="Function_4191" unitType="Default" scalingCompartment="CN=Root,Model=3-enzyme linear pathway with gene expression,Vector=Compartments[compartment]">
          <ListOfCallParameters>
  ...
  <rdf:Description rdf:about="#Reaction_3759">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5455" name="k1" value="1.36308e+10"/>
        </ListOfConstants>
...
<dcterms:W3CDTF>2020-12-22T20:36:54Z</dcterms:W3CDTF>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5450" name="V" value="1.18071"/>
          <Constant key="Parameter_5459" name="K" value="0.000873788"/>
        </ListOfConstants>
        <KineticLaw function="Function_4191" unitType="Default" scalingCompartment="CN=Root,Model=3-enzyme linear pathway with gene expression,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_25767">
...
<dcterms:W3CDTF>2020-12-22T20:36:54Z</dcterms:W3CDTF>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5461" name="k1" value="418.156"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=3-enzyme linear pathway with gene expression,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<dcterms:W3CDTF>2020-12-22T20:36:54Z</dcterms:W3CDTF>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5458" name="V" value="3.91648e+09"/>
          <Constant key="Parameter_5464" name="K" value="0.0590694"/>
        </ListOfConstants>
        <KineticLaw function="Function_4191" unitType="Default" scalingCompartment="CN=Root,Model=3-enzyme linear pathway with gene expression,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_25767">
...
<dcterms:W3CDTF>2020-12-22T20:36:54Z</dcterms:W3CDTF>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5465" name="k1" value="5.43385e-08"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=3-enzyme linear pathway with gene expression,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<dcterms:W3CDTF>2020-12-22T20:36:54Z</dcterms:W3CDTF>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5460" name="V" value="8.0471e-06"/>
          <Constant key="Parameter_5469" name="Kr" value="3.86399e+09"/>
          <Constant key="Parameter_5463" name="hr" value="1.17071"/>
          <Constant key="Parameter_5468" name="Ki" value="128.423"/>
          <Constant key="Parameter_5466" name="hi" value="0.237438"/>
        </ListOfConstants>
        <KineticLaw function="Function_4192" unitType="Default" scalingCompartment="CN=Root,Model=3-enzyme linear pathway with gene expression,Vector=Compartments[compartment]">
          <ListOfCallParameters>
...
<dcterms:W3CDTF>2020-12-22T20:36:54Z</dcterms:W3CDTF>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5467" name="k1" value="2713.9"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=3-enzyme linear pathway with gene expression,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<dcterms:W3CDTF>2020-12-22T20:36:54Z</dcterms:W3CDTF>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5462" name="V" value="5.54494e-11"/>
          <Constant key="Parameter_5493" name="Kr" value="0.00165854"/>
          <Constant key="Parameter_5492" name="hr" value="0.58"/>
          <Constant key="Parameter_5477" name="Ki" value="1.99661e-06"/>
          <Constant key="Parameter_5471" name="hi" value="1.04453"/>
        </ListOfConstants>
        <KineticLaw function="Function_4192" unitType="Default" scalingCompartment="CN=Root,Model=3-enzyme linear pathway with gene expression,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_25762">
...
<dcterms:W3CDTF>2020-12-22T20:36:54Z</dcterms:W3CDTF>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5476" name="k1" value="6.38701e+06"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=3-enzyme linear pathway with gene expression,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<dcterms:W3CDTF>2020-12-22T20:36:54Z</dcterms:W3CDTF>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5474" name="V" value="17319.1"/>
          <Constant key="Parameter_5475" name="Kr" value="452.268"/>
          <Constant key="Parameter_5470" name="hr" value="0.451442"/>
          <Constant key="Parameter_5479" name="Ki" value="0.140194"/>
          <Constant key="Parameter_5481" name="hi" value="0.936739"/>
        </ListOfConstants>
        <KineticLaw function="Function_4192" unitType="Default" scalingCompartment="CN=Root,Model=3-enzyme linear pathway with gene expression,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_25762">
...
<dcterms:W3CDTF>2020-12-22T20:36:54Z</dcterms:W3CDTF>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5478" name="k1" value="9170.7"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=3-enzyme linear pathway with gene expression,Vector=Compartments[compartment]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2020-12-24T17:22:02Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_26" name="Scan" type="scan" scheduled="true" updateModel="false">
      <Report reference="Report_0" target="FoundationSysBioFit.out" append="1" confirmOverwrite="0"/>
      <Problem>
  ...
  <ListOfPlots>
    <PlotSpecification name="[M1]" type="Plot2D" active="0" taskTypes="">
    ...
    <PlotSpecification name="[M2]" type="Plot2D" active="0" taskTypes="">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="Experiment(Measured Value)" type="Curve2D">
    ...
    <PlotSpecification name="[E1]" type="Plot2D" active="0" taskTypes="">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="Experiment(Measured Value)" type="Curve2D">
    ...
    <PlotSpecification name="[E2]" type="Plot2D" active="0" taskTypes="">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="Experiment(Measured Value)" type="Curve2D">
    ...
    <PlotSpecification name="[E3]" type="Plot2D" active="0" taskTypes="">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="Experiment(Measured Value)" type="Curve2D">
    ...
    <PlotSpecification name="[G1]" type="Plot2D" active="0" taskTypes="">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="Experiment(Measured Value)" type="Curve2D">
    ...
    <PlotSpecification name="[G2]" type="Plot2D" active="0" taskTypes="">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="Experiment(Measured Value)" type="Curve2D">
    ...
    <PlotSpecification name="[G3]" type="Plot2D" active="0" taskTypes="">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="Experiment(Measured Value)" type="Curve2D">
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2020-12-24T15:10:22Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
