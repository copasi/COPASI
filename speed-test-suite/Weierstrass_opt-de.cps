...
<!-- generated with COPASI 4.29 (Build 228) (http://www.copasi.org) at 2021-01-03T18:34:49Z -->
...
<dcterms:W3CDTF>2021-01-03T18:32:55Z</dcterms:W3CDTF>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_2" name="Scan" type="scan" scheduled="true" updateModel="false">
      <Report reference="Report_11" target="Weierstrass_opt-de.out" append="1" confirmOverwrite="0"/>
      <Problem>
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="OptimizationItem">
            ...
            <Parameter name="StartValue" type="float" value="0.46035648834899923"/>
          ...
          <ParameterGroup name="OptimizationItem">
            ...
            <Parameter name="StartValue" type="float" value="-0.09921419797446912"/>
            <Parameter name="UpperBound" type="cn" value="0.5"/>
          </ParameterGroup>
        </ParameterGroup>
