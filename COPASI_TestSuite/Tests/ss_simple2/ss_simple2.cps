...
<!-- generated with COPASI 4.4.28 (Debug) (http://www.copasi.org) at 2008-10-16 14:22:20 UTC -->
  ...
  <Model key="Model_0" name="New Model" timeUnit="s" volumeUnit="ml" quantityUnit="mmol" type="deterministic">
    ...
    <ListOfReactions>
      <Reaction key="Reaction_0" name="R1" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_87" name="v" value="0.1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_1" name="R2" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_86" name="k1" value="0.2"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_2" name="R3" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_466" name="k1" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
    ...
    <InitialState type="initialState">
      0 6.022141500000001e+18 6.022141500000001e+18 1
    </InitialState>
  </Model>
  <ListOfTasks>
    <Task key="Task_10" name="Steady-State" type="steadyState" scheduled="true" updateModel="false">
      <Report reference="Report_6" target="ss_simple2_result.txt" append="0"/>
      <Problem>
