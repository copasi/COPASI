...
<!-- generated with COPASI 4.4.28 (Debug) (http://www.copasi.org) at 2008-10-31 23:48:55 UTC -->
<COPASI xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.copasi.org/static/schema.xsd" versionMajor="1" versionMinor="0" versionDevel="28">
  ...
  <Model key="Model_1" name="New Model" timeUnit="s" volumeUnit="ml" quantityUnit="mmol" type="deterministic">
    <Comment>
      <html xmlns="http://www.w3.org/1999/xhtml"><head><meta name="qrichtext" content="1" /></head><body style="font-size:8pt;font-family:Lucida Sans">
<p>Test for #1033.</p>
<p>A stochastic simulation is done for a model where an assignment rule influences the rate law of a reaction. </p>
</body></html>
    </Comment>
    <ListOfCompartments>
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_0" name="X" simulationType="assignment">
        <Expression>
          &lt;CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[A],Reference=ParticleNumber&gt;*1e-4
        </Expression>
      </ModelValue>
    </ListOfModelValues>
    <ListOfReactions>
      <Reaction key="Reaction_0" name="reaction" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_89" name="v" value="0.01"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_1" name="reaction_1" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_88" name="v" value="0.1"/>
        </ListOfConstants>
        <KineticLaw function="Function_6">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_12" name="Time-Course" type="timeCourse" scheduled="true" updateModel="false">
      <Report reference="Report_6" target="stoch_assignment_result.txt" append="0"/>
      <Problem>
  ...
  <ListOfReports>
    ...
    <Report key="Report_6" name="Time, Particle Numbers, Volumes, and Global Quantity Values" taskType="timeCourse" separator="&#x09;" precision="6">
      <Comment>
        <body xmlns="http://www.w3.org/1999/xhtml">
      ...
      <Table printTitle="1">
        ...
        <Object cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[B],Reference=ParticleNumber"/>
