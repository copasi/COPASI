...
<!-- generated with COPASI 4.9.37+ (Debug) (http://www.copasi.org) at 2012-10-09 17:44:46 UTC -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="4" versionMinor="9" versionDevel="37" copasiSourcesModified="1">
  <Model key="Model_0" name="case00936" simulationType="time" timeUnit="s" volumeUnit="l" areaUnit="m²" lengthUnit="m" quantityUnit="mol" type="deterministic" avogadroConstant="6.02214179e+23">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_0">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2011-05-26T16:29:51Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Compartment_1">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2011-05-26T16:31:22Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_14" name="S1" simulationType="assignment" compartment="Compartment_1">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_14">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2011-05-26T16:31:24Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
        ...
        <Expression>
          if(&lt;CN=Root,Model=case00936,Reference=Time&gt; le 2,sin(&lt;CN=Root,Model=case00936,Reference=Time&gt;*10),1)
        </Expression>
      </Metabolite>
      <Metabolite key="Metabolite_13" name="S2" simulationType="reactions" compartment="Compartment_1">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_13">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2011-05-26T16:31:50Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
    ...
    <ListOfEvents>
      <Event key="Event_0" name="_E0" delayAssignment="false" fireAtInitialTime="0" persistentTrigger="0">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Event_0">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2011-05-26T16:30:05Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
        ...
        <TriggerExpression>
          &lt;CN=Root,Model=case00936,Vector=Compartments[default_compartment],Vector=Metabolites[S1],Reference=Concentration&gt; lt 0
        </TriggerExpression>
        <DelayExpression>
          2
        </DelayExpression>
        <ListOfAssignments>
          <Assignment targetKey="Metabolite_13">
            <Expression>
              &lt;CN=Root,Model=case00936,Vector=Compartments[default_compartment],Vector=Metabolites[S2],Reference=Concentration&gt;+1
            </Expression>
          </Assignment>
        </ListOfAssignments>
      </Event>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_1" name="Time-Course" type="timeCourse" scheduled="true" updateModel="false">
      <Report reference="Report_7" target="EventTest11_result.txt" append="0" confirmOverwrite="0"/>
      <Problem>
  ...
  <ListOfReports>
    ...
    <Report key="Report_7" name="Events" taskType="timeCourse" separator="&#x09;" precision="7">
      ...
      <Table printTitle="1">
        <Object cn="CN=Root,Model=case00936,Reference=Time"/>
        <Object cn="CN=Root,Model=case00936,Vector=Compartments[default_compartment],Vector=Metabolites[S1],Reference=Concentration"/>
        <Object cn="CN=Root,Model=case00936,Vector=Compartments[default_compartment],Vector=Metabolites[S2],Reference=Concentration"/>
      </Table>
    </Report>
    ...
    <PlotSpecification name="Concentrations, Volumes, and Global Quantity Values" type="Plot2D" active="1">
      ...
      <ListOfPlotItems>
        <PlotItem name="[S1]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=case00936,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=case00936,Vector=Compartments[default_compartment],Vector=Metabolites[S1],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[S2]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=case00936,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=case00936,Vector=Compartments[default_compartment],Vector=Metabolites[S2],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
  ...
  <SBMLReference file="00936-sbml-l2v4.xml">
    <SBMLMap SBMLid="S1" COPASIkey="Metabolite_14"/>
    <SBMLMap SBMLid="S2" COPASIkey="Metabolite_13"/>
