...
<!-- generated with COPASI 4.4.27 (development) (http://www.copasi.org) at 2008-10-19 23:43:04 UTC -->
<COPASI xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.copasi.org/static/schema.xsd" versionMajor="1" versionMinor="0" versionDevel="27">
  ...
  <Model key="Model_1" name="Kinetics fitting from spectrophotometer data" timeUnit="s" volumeUnit="ml" quantityUnit="mmol" type="deterministic">
    <Comment>
...
<p>This file is an example of parameter estimation for a progress curve. It attempts to fit parameters of the Michaelis-Menten mechanism to synthetic data (generated with the same mechanism and with added Gaussian noise). </p>
<p>We attempt to fit the parameters (R1)k2 and (R2)k1; their original values were: (R1)k2=4 and (R2)k1=45 </p>
<ul type="disc"><li>Check how the data file is formatted and how one specifies that in the Fitting page. </li>
<li>Check how the signal (eg absorbance) was specified as a user function. </li>
<li>Check how the offsets were made uncertain in the fit. -Experiment with several optimisation methods.</li></ul>
</body></html>
    </Comment>
    <ListOfCompartments>
    ...
    <ListOfModelValues>
      ...
      <ModelValue key="ModelValue_2" name="signal" simulationType="assignment">
        <Expression>
          &lt;CN=Root,Model=Kinetics fitting from spectrophotometer data,Vector=Values[offset],Reference=Value&gt;+&lt;CN=Root,Model=Kinetics fitting from spectrophotometer data,Vector=Compartments[compartment],Vector=Metabolites[P],Reference=Concentration&gt;*&lt;CN=Root,Model=Kinetics fitting from spectrophotometer data,Vector=Values[epsilon],Reference=Value&gt;
        </Expression>
      </ModelValue>
    </ListOfModelValues>
    <ListOfReactions>
      <Reaction key="Reaction_0" name="R1" reversible="true">
        ...
        <ListOfConstants>
          <Constant key="Parameter_899" name="k1" value="130"/>
          <Constant key="Parameter_898" name="k2" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_14">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_62">
              <SourceParameter reference="Parameter_899"/>
            </CallParameter>
            ...
            <CallParameter functionParameter="FunctionParameter_67">
              <SourceParameter reference="Parameter_898"/>
            </CallParameter>
      ...
      <Reaction key="Reaction_1" name="R2" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_897" name="k1" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
              <SourceParameter reference="Parameter_897"/>
            </CallParameter>
    ...
    <InitialState type="initialState">
      0 6.022141500000001e+18 6.022141500000001e+21 0 0 0 0.78 0 1
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_14" name="Optimization" type="optimization" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <Parameter name="ObjectiveFunction" type="key" value="Function_46"/>
    ...
    <Task key="Task_15" name="Parameter Estimation" type="parameterFitting" scheduled="true" updateModel="false">
      <Report reference="Report_6" target="param_est1_results.txt" append="0"/>
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Kinetics fitting from spectrophotometer data,Vector=Reactions[R1],ParameterGroup=Parameters,Parameter=k2,Reference=Value"/>
            <Parameter name="StartValue" type="float" value="171.12"/>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="LowerBound" type="cn" value="1e-6"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Kinetics fitting from spectrophotometer data,Vector=Reactions[R2],ParameterGroup=Parameters,Parameter=k1,Reference=Value"/>
            <Parameter name="StartValue" type="float" value="0.000104799"/>
            <Parameter name="UpperBound" type="cn" value="1e6"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Kinetics fitting from spectrophotometer data,Vector=Values[offset],Reference=InitialValue"/>
        ...
        <ParameterGroup name="Experiment Set">
          <ParameterGroup name="Experiment">
            ...
            <Parameter name="File Name" type="file" value="mmspect.dat"/>
            ...
            <ParameterGroup name="Object Map">
              <ParameterGroup name="0">
                ...
                <Parameter name="Object CN" type="cn" value="CN=Root,Model=Kinetics fitting from spectrophotometer data,Vector=Compartments[compartment],Vector=Metabolites[S],Reference=InitialConcentration"/>
              </ParameterGroup>
              ...
              <ParameterGroup name="2">
                ...
                <Parameter name="Object CN" type="cn" value="CN=Root,Model=Kinetics fitting from spectrophotometer data,Vector=Values[signal],Reference=Value"/>
              </ParameterGroup>
            </ParameterGroup>
          </ParameterGroup>
  ...
  <ListOfReports>
    ...
    <Report key="Report_6" name="ssq4test" taskType="timeCourse" separator="&#x09;" precision="6">
      <Comment>
        <body xmlns="http://www.w3.org/1999/xhtml">
      ...
      <Header>
        <Object cn="String=SSq"/>
        <Object cn="Separator=&#x09;"/>
        <Object cn="String=func.eval."/>
        <Object cn="Separator=&#x09;"/>
        <Object cn="String=Parameter values"/>
      </Header>
      <Footer>
        <Object cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,Reference=Best Value"/>
        <Object cn="Separator=&#x09;"/>
  ...
  <ListOfPlots>
    ...
    <PlotSpecification name="Data versus model fit" type="Plot2D" active="1">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="signal(1)" type="Curve2D">
        ...
        <PlotItem name="model(1)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="after"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,ParameterGroup=Experiment Set,ParameterGroup=Experiment,Vector=Fitted Points[0],Reference=Independent Value"/>
        ...
        <PlotItem name="signal(2)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="2"/>
          <Parameter name="Recording Activity" type="string" value="after"/>
          <ListOfChannels>
        ...
        <PlotItem name="model(2)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="after"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,ParameterGroup=Experiment Set,ParameterGroup=Experiment_1,Vector=Fitted Points[0],Reference=Independent Value"/>
        ...
        <PlotItem name="signal(3)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="2"/>
          <Parameter name="Recording Activity" type="string" value="after"/>
          <ListOfChannels>
        ...
        <PlotItem name="model(3)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="after"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,ParameterGroup=Experiment Set,ParameterGroup=Experiment_2,Vector=Fitted Points[0],Reference=Independent Value"/>
        ...
        <PlotItem name="signal(4)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="2"/>
          <Parameter name="Recording Activity" type="string" value="after"/>
          <ListOfChannels>
        ...
        <PlotItem name="model(4)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="after"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,ParameterGroup=Experiment Set,ParameterGroup=Experiment_3,Vector=Fitted Points[0],Reference=Independent Value"/>
        ...
        <PlotItem name="signal(5)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="2"/>
          <Parameter name="Recording Activity" type="string" value="after"/>
          <ListOfChannels>
        ...
        <PlotItem name="model(5)" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="after"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,ParameterGroup=Experiment Set,ParameterGroup=Experiment_4,Vector=Fitted Points[0],Reference=Independent Value"/>
    ...
    <PlotSpecification name="Residuals" type="Plot2D" active="1">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="exp1" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="2"/>
          <Parameter name="Recording Activity" type="string" value="after"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,ParameterGroup=Experiment Set,ParameterGroup=Experiment,Vector=Fitted Points[0],Reference=Independent Value"/>
        ...
        <PlotItem name="exp2" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="2"/>
          <Parameter name="Recording Activity" type="string" value="after"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,ParameterGroup=Experiment Set,ParameterGroup=Experiment_1,Vector=Fitted Points[0],Reference=Independent Value"/>
        ...
        <PlotItem name="exp3" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="2"/>
          <Parameter name="Recording Activity" type="string" value="after"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,ParameterGroup=Experiment Set,ParameterGroup=Experiment_2,Vector=Fitted Points[0],Reference=Independent Value"/>
        ...
        <PlotItem name="exp4" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="2"/>
          <Parameter name="Recording Activity" type="string" value="after"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,ParameterGroup=Experiment Set,ParameterGroup=Experiment_3,Vector=Fitted Points[0],Reference=Independent Value"/>
        ...
        <PlotItem name="exp5" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="2"/>
          <Parameter name="Recording Activity" type="string" value="after"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Vector=TaskList[Parameter Estimation],Problem=Parameter Estimation,ParameterGroup=Experiment Set,ParameterGroup=Experiment_4,Vector=Fitted Points[0],Reference=Independent Value"/>
