...
<!-- generated with COPASI 4.3.25 (Debug) (http://www.copasi.org) at 2008-02-22 13:24:31 UTC -->
<COPASI xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.copasi.org/static/schema.xsd" versionMajor="1" versionMinor="0" versionDevel="25">
  <ListOfFunctions>
    ...
    <Function key="Function_45" name="Objective Function 1" type="Expression">
      <Expression>
  ...
  <Model key="Model_0" name="New Model" timeUnit="s" volumeUnit="ml" quantityUnit="mmol" type="deterministic">
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_1" name="A" simulationType="reactions" compartment="Compartment_0">
      </Metabolite>
      <Metabolite key="Metabolite_0" name="B" simulationType="reactions" compartment="Compartment_0">
      </Metabolite>
    </ListOfMetabolites>
    <ListOfReactions>
    ...
    <InitialState type="initialState">
      0 6.022141500000001e+19 6.022141500000001e+19 1
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_1" name="Time-Course" type="timeCourse" scheduled="true" updateModel="false">
      <Report reference="Report_7" target="test2_result.txt" append="0"/>
      <Problem>
  ...
  <ListOfReports>
    ...
    <Report key="Report_7" name="Time, Concentrations, Volumes, and Global Quantity Values" taskType="timeCourse" separator="&#x09;" precision="6">
      <Comment>
        <body xmlns="http://www.w3.org/1999/xhtml">
