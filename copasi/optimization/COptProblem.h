...
public:
   ...
   */
  COptItem & addOptConstraint(const CRegisteredCommonName & objectCN);
   ...
   * @return COptItem optItemAdded
   */
  COptItem & addOptItem(const CRegisteredCommonName & objectCN);
   ...
   * @return CCommonName
   */
  CRegisteredCommonName setSubtaskType(const CTaskEnum::Task & subtaskType);
...
protected:
   ...
   */
  CRegisteredCommonName * mpParmSubTaskCN;
