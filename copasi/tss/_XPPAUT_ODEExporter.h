/* Begin CVS Header
   $Source: /Volumes/Home/Users/shoops/cvs/copasi_dev/copasi/tss/Attic/_XPPAUT_ODEExporter.h,v $
   $Revision: 1.1 $
   $Name:  $
   $Author: nsimus $
...
#ifndef _XPPAUT_ODEExpoter_H__
#define _XPPAUT_ODEExpoter_H__

#include "ODEExporter.h"

class _XPPAUT_ODEExporter: public ODEExporter
  {
  protected:
