/* Begin CVS Header
   $Source: /Volumes/Home/Users/shoops/cvs/copasi_dev/copasi/tss/Attic/_C_ODEExporter.h,v $
   $Revision: 1.1 $
   $Name:  $
   $Author: nsimus $
...
#ifndef _C_ODEExpoter_H__
#define _C_ODEExpoter_H__

#include "ODEExporter.h"

class _C_ODEExporter: public ODEExporter
  {
  protected:
