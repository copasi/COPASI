...
TEMPLATE = app
SRC_TARGET = ViewCurrentUI
DISTFILES = ViewCurrentUI.pro

CONFIG += qt

# Input
HEADERS += resource.h arguments.h worker.h

SOURCES += main.cpp arguments.cpp worker.cpp

DISTFILES += ViewCurrentUI.rc
