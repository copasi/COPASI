...
**
** Created: Tue Oct 19 15:51:20 2004
**      by: The User Interface Compiler ($Id: curve2dwidget.cpp,v 1.1.1.1 2004/10/26 15:18:00 anuragr Exp $)
**
    ...
    : QWidget( parent, name, fl )
{
    ...
    Curve2DWidgetLayout->addItem( spacer1, 8, 2 );
