// Begin CVS Header
//   $Source: /Volumes/Home/Users/shoops/cvs/copasi_dev/copasi/trajectory/Attic/CTimeScaleSeparationILDM.h,v $
//   $Revision: 1.1 $
//   $Name:  $
//   $Author: nsimus $
...
#ifndef COPASI_CTimeScaleSeparationILDM
#define COPASI_CTimeScaleSeparationILDM
...
class CTimeScaleSeparationILDM : public CTrajectoryMethod
  {
  ...
  public:
    struct Data
      {
        C_INT dim;
        CTimeScaleSeparationILDM * pMethod;
      };
  ...
  private:
     ...
     */
    CTimeScaleSeparationILDM(const CCopasiContainer * pParent = NULL);

  public:
    /**
     * Copy constructor.
     * @param "const CTimeScaleSeparationILDM &" src
     * @param const CCopasiContainer * pParent (default: NULL)
     */
    CTimeScaleSeparationILDM(const CTimeScaleSeparationILDM & src,
                             const CCopasiContainer * pParent = NULL);

    /**
     *  Destructor.
     */
    ~CTimeScaleSeparationILDM();
...
#endif // COPASI_CTimeScaleSeparationILDM
