// Begin CVS Header
//   $Source: /Volumes/Home/Users/shoops/cvs/copasi_dev/copasi/trajectory/Attic/CTimeScaleSeparationILDM.cpp,v $
//   $Revision: 1.1 $
//   $Name:  $
//   $Author: nsimus $
//   $Date: 2007/02/20 09:54:40 $
// End CVS Header
...
CTimeScaleSeparationILDM::CTimeScaleSeparationILDM(const CCopasiContainer * pParent):
    CTrajectoryMethod(CCopasiMethod::tssILDM, pParent),
    mpState(NULL),
    mY(NULL)
{
...
CTimeScaleSeparationILDM::CTimeScaleSeparationILDM(const CTimeScaleSeparationILDM & src,
...
CTimeScaleSeparationILDM::~CTimeScaleSeparationILDM()
{
  pdelete(mpState);
}

void CTimeScaleSeparationILDM::initializeParameter()
{
...
bool CTimeScaleSeparationILDM::elevateChildren()
{
  initializeParameter();
  return true;
}

void CTimeScaleSeparationILDM::integrationStep(const double & deltaT)
{
  mLsodaStatus = 1;
  mState = 1;
  mJType = 2;
...
void CTimeScaleSeparationILDM::step(const double & deltaT)
{
...
void CTimeScaleSeparationILDM::mat_anal_mod(C_INT & slow)
{
...
void CTimeScaleSeparationILDM::mat_anal_metab(C_INT & slow)
{
...
void CTimeScaleSeparationILDM::mat_anal_mod_space(C_INT & slow)
{
...
void CTimeScaleSeparationILDM::schur()
{
...
void CTimeScaleSeparationILDM::sylvester(C_INT slow, C_INT & info)
{
  char N1 = 'N';
  char N2 = 'N';
  C_INT isgn = -1;
...
void CTimeScaleSeparationILDM::evalsort(C_FLOAT64 *reval, const C_INT & dim)
{
  C_INT i, j, min;
  C_FLOAT64 tmp1r;
...
/**
  ...
  mTd and mTdinverse
 */
void CTimeScaleSeparationILDM::deuflhard(C_INT & slow, C_INT & info)
{
...
void CTimeScaleSeparationILDM::newton(C_FLOAT64 *ys, C_INT & slow, C_INT & info)
{
...
void CTimeScaleSeparationILDM::calculateDerivativesX(C_FLOAT64 * X1, C_FLOAT64 * Y1)
{
  C_INT i, imax;
  C_INT indep;
...
void CTimeScaleSeparationILDM::map_index(C_FLOAT64 *eval_r, C_INT *index, const C_INT & dim)
{
  C_INT i, j, count;
  C_INT max;
 ...
 */
void CTimeScaleSeparationILDM::update_nid(C_INT *index, C_INT *nid, const C_INT & dim)
{
  C_INT k;
 ...
 */
void CTimeScaleSeparationILDM::update_pid(C_INT *index, C_INT *pid, const C_INT & dim)
{
  C_INT k;
...
void CTimeScaleSeparationILDM::start(const CState * initialState)
{
...
void CTimeScaleSeparationILDM::initializeAtol()
{
...
void CTimeScaleSeparationILDM::EvalF(const C_INT * n, const C_FLOAT64 * t, const C_FLOAT64 * y, C_FLOAT64 * ydot)
{static_cast<Data *>((void *) n)->pMethod->evalF(t, y, ydot);}

void CTimeScaleSeparationILDM::evalF(const C_FLOAT64 * t, const C_FLOAT64 * y, C_FLOAT64 * ydot)
{
  assert (y == mY);
