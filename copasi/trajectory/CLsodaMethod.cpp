                         ...
                         C_FLOAT64 * ydot)  /* Fortran style vector */
{
  ...
  const_cast<CModel *>(mpStateC->getModel())->getDerivatives_particles(mpStateC, ydot + 1);
                         ...
                         C_FLOAT64 * ydot)  /* Fortran style vector */
{
  ...
  const_cast<CModel *>(mpStateR->getModel())->getDerivativesX_particles(mpStateR, ydot + 1);
