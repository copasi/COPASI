 ...
 **
 ** Created: Tue Jun 4 11:19:04 2002
 **      by: The Qt MOC ($Id: ReactionsWidget.moc.cpp,v 1.1 2002/06/04 15:57:07 shoops Exp $)
 **
...
{
  if (!qstrcmp(clname, "ReactionsWidget"))
    return (ReactionsWidget*)this;
