 ...
 **
 ** Created: Fri Aug 18 13:56:16 2006
 **      by: The User Interface Compiler ($Id: CQFittingItemWidget.cpp,v 1.17 2006/08/18 18:33:23 shoops Exp $)
 **
    ...
    : QWidget(parent, name, fl)
{
  ...
  mpBtnReset->setIconSet(QIconSet(image3));
  mpLayoutStart->addWidget(mpBtnReset);

  layout11->addLayout(mpLayoutStart, 3, 3);

  mpLblExperiments = new QLabel(this, "mpLblExperiments");

  layout11->addMultiCellWidget(mpLblExperiments, 4, 4, 0, 2);

  mpBtnUp = new QToolButton(this, "mpBtnUp");
  mpBtnUp->setMaximumSize(QSize(20, 20));
  mpBtnUp->setIconSet(QIconSet(image4));

  layout11->addWidget(mpBtnUp, 0, 6);

  mpLblUpper_2 = new QLabel(this, "mpLblUpper_2");

  layout11->addMultiCellWidget(mpLblUpper_2, 3, 3, 0, 1);

  mpBtnPerExperiment = new QPushButton(this, "mpBtnPerExperiment");

  layout11->addMultiCellWidget(mpBtnPerExperiment, 5, 5, 0, 6);
  ...
  mpBtnUpperEdit->setIconSet(QIconSet(image1));
  mpLayoutUpper->addWidget(mpBtnUpperEdit);

  layout11->addLayout(mpLayoutUpper, 2, 3);

  mpLblUpper = new QLabel(this, "mpLblUpper");

  layout11->addMultiCellWidget(mpLblUpper, 2, 2, 0, 1);
  ...
  mpBtnExperiments->setIconSet(QIconSet(image3));
  mpLayoutExperiments->addWidget(mpBtnExperiments);

  layout11->addLayout(mpLayoutExperiments, 4, 3);

  mpLblObject = new QLabel(this, "mpLblObject");

  layout11->addMultiCellWidget(mpLblObject, 0, 0, 0, 2);
  CQFittingItemWidgetLayout->addLayout(layout11);
  languageChange();
  resize(QSize(334, 249).expandedTo(minimumSizeHint()));
...
void CQFittingItemWidget::languageChange()
{
  ...
  mpLblUpper_2->setText(tr("Start Value"));
