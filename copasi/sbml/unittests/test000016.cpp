...
CCopasiDataModel* test000016::pCOPASIDATAMODEL = NULL;

void test000016::setUp()
{
...
void test000016::tearDown()
{
  delete CCopasiRootContainer::Root;
  CCopasiRootContainer::Root = NULL;
}

void test000016::test_references_to_species()
{
  // load the CPS file
  // export to SBML
  // check the resulting SBML model
  CCopasiDataModel* pDataModel = pCOPASIDATAMODEL;
  std::istringstream iss(test000016::MODEL_STRING);
...
const char* test000016::MODEL_STRING =
  "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
  "<!-- generated with COPASI 4.3.25 (Debug) (http://www.copasi.org) at 2008-02-15 09:42:41 UTC -->\n"
  ...
  "<p>Model with variable volume compartment,# quantity units and a reference to the species initial amount.</p>\n"
  "<p>On export this should create an SBML file with the hasOnlySubstanceUnits flag on the species set.</p>\n"
  "<p>The reference in the initial assignment should be unmodified, the references in the reactions should be divided by the volume.</p>\n"
  "</body></html>\n"
  "    </Comment>\n"
  "    <ListOfCompartments>\n"
