...
CCopasiDataModel* test000007::pCOPASIDATAMODEL = NULL;

void test000007::setUp()
{
...
void test000007::tearDown()
{
  CCopasiRootContainer::destroy();
}

void test000007::test_references_to_species()
{
  // load the CPS file
  // export to SBML
  // check the resulting SBML model
  CCopasiDataModel* pDataModel = pCOPASIDATAMODEL;
  std::istringstream iss(test000007::MODEL_STRING);
  ...
  // the expression should be a multiplication of the species, a constant and
...
const char* test000007::MODEL_STRING =
  "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
  "<!-- generated with COPASI 4.3.25 (Debug) (http://www.copasi.org) at 2008-02-15 09:32:11 UTC -->\n"
  ...
  "<p>Model with constant volume compartment,mmol quantity units and a reference to the species initial amount.</p>\n"
  "<p>On export this should create an SBML file with the hasOnlySubstanceUnits flag on the species unset.</p>\n"
  "<p>The reference to the species in the initial assignment should be multiplied by a factor (6.023e20) as well as the volume of the compartment.</p>\n"
  "</body></html>\n"
  "    </Comment>\n"
  "    <ListOfCompartments>\n"
