...
void test000078::test_l2v4_import_unordered_functions()
{
  ...
  CPPUNIT_ASSERT(pRoot->subType() == CEvaluationNode::S_MULTIPLY);
  ...
  CPPUNIT_ASSERT(pChild->subType() == CEvaluationNode::S_DEFAULT);
  ...
  CPPUNIT_ASSERT(pRoot != NULL);
  CPPUNIT_ASSERT(pRoot->mainType() == CEvaluationNode::T_OPERATOR);
  CPPUNIT_ASSERT(pRoot->subType() == CEvaluationNode::S_PLUS);
  ...
  CPPUNIT_ASSERT(pRoot != NULL);
  CPPUNIT_ASSERT(pRoot->mainType() == CEvaluationNode::T_OPERATOR);
  CPPUNIT_ASSERT(pRoot->subType() == CEvaluationNode::S_MINUS);
  pChild = dynamic_cast<const CEvaluationNode*>(pRoot->getChild());
  CPPUNIT_ASSERT(pChild != NULL);
  CPPUNIT_ASSERT(pChild->mainType() == CEvaluationNode::T_VARIABLE);
  CPPUNIT_ASSERT(pChild->subType() == CEvaluationNode::S_DEFAULT);
  ...
  pChild = dynamic_cast<const CEvaluationNode*>(pRoot->getChild());
  CPPUNIT_ASSERT(pChild != NULL);
  CPPUNIT_ASSERT(pChild->mainType() == CEvaluationNode::T_CALL);
  CPPUNIT_ASSERT(pChild->subType() == CEvaluationNode::S_FUNCTION);
  ...
  pRoot = pKinFun->getRoot();
  CPPUNIT_ASSERT(pRoot != NULL);
  CPPUNIT_ASSERT(pRoot->mainType() == CEvaluationNode::T_CALL);
  CPPUNIT_ASSERT(pRoot->subType() == CEvaluationNode::S_FUNCTION);
