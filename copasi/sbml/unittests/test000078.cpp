...
void test000078::test_l2v4_import_unordered_functions()
{
  ...
  CPPUNIT_ASSERT((CEvaluationNodeOperator::SubType)CEvaluationNode::subType(pRoot->getType()) == CEvaluationNodeOperator::MULTIPLY);
  ...
  CPPUNIT_ASSERT((CEvaluationNodeVariable::SubType)CEvaluationNode::subType(pChild->getType()) == CEvaluationNodeVariable::ANY);
  ...
  CPPUNIT_ASSERT(pRoot != NULL);
  CPPUNIT_ASSERT(CEvaluationNode::type(pRoot->getType()) == CEvaluationNode::OPERATOR);
  CPPUNIT_ASSERT((CEvaluationNodeOperator::SubType)CEvaluationNode::subType(pRoot->getType()) == CEvaluationNodeOperator::PLUS);
  ...
  CPPUNIT_ASSERT(pRoot != NULL);
  CPPUNIT_ASSERT(CEvaluationNode::type(pRoot->getType()) == CEvaluationNode::OPERATOR);
  CPPUNIT_ASSERT((CEvaluationNodeOperator::SubType)CEvaluationNode::subType(pRoot->getType()) == CEvaluationNodeOperator::MINUS);
  pChild = dynamic_cast<const CEvaluationNode*>(pRoot->getChild());
  CPPUNIT_ASSERT(pChild != NULL);
  CPPUNIT_ASSERT(CEvaluationNode::type(pChild->getType()) == CEvaluationNode::VARIABLE);
  CPPUNIT_ASSERT((CEvaluationNodeVariable::SubType)CEvaluationNode::subType(pChild->getType()) == CEvaluationNodeVariable::ANY);
  ...
  pChild = dynamic_cast<const CEvaluationNode*>(pRoot->getChild());
  CPPUNIT_ASSERT(pChild != NULL);
  CPPUNIT_ASSERT(CEvaluationNode::type(pChild->getType()) == CEvaluationNode::CALL);
  CPPUNIT_ASSERT((CEvaluationNodeCall::SubType)CEvaluationNode::subType(pChild->getType()) == CEvaluationNodeCall::FUNCTION);
  ...
  pRoot = pKinFun->getRoot();
  CPPUNIT_ASSERT(pRoot != NULL);
  CPPUNIT_ASSERT(CEvaluationNode::type(pRoot->getType()) == CEvaluationNode::CALL);
  CPPUNIT_ASSERT((CEvaluationNodeCall::SubType)CEvaluationNode::subType(pRoot->getType()) == CEvaluationNodeCall::FUNCTION);
