...
CCopasiDataModel* test000037::pCOPASIDATAMODEL = NULL;

void test000037::setUp()
{
...
void test000037::tearDown()
{
  delete CCopasiRootContainer::Root;
  CCopasiRootContainer::Root = NULL;
}

void test000037::test_hasOnlySubstanceUnits()
{
...
const char* test000037::MODEL_STRING =
