...
CCopasiDataModel* test000020::pCOPASIDATAMODEL = NULL;

void test000020::setUp()
{
...
void test000020::tearDown()
{
  delete CCopasiRootContainer::Root;
  CCopasiRootContainer::Root = NULL;
}

void test000020::test_references_to_species()
{
  // load the CPS file
  // export to SBML
  ...
  // the species node divided by the compartment volume
  // the mutliplication and the division of the compartment volume cancel each
  // other out.
...
const char* test000020::MODEL_STRING =
  "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
  "<!-- generated with COPASI 4.3.25 (Debug) (http://www.copasi.org) at 2008-02-15 09:48:53 UTC -->\n"
  ...
  "<p>The reference to the species in the initial assignment should be multiplied by a factor (6.023e17) and the references in the reactions should be divided by the volume.</p>\n"
  "</body></html>\n"
  "    </Comment>\n"
  "    <ListOfCompartments>\n"
