// Begin CVS Header
//   $Source: /Volumes/Home/Users/shoops/cvs/copasi_dev/copasi/sbml/unittests/test000018.cpp,v $
//   $Revision: 1.3 $
//   $Name:  $
//   $Author: gauges $
//   $Date: 2009/02/18 20:37:13 $
// End CVS Header
...
CCopasiDataModel* test000018::pCOPASIDATAMODEL = NULL;

void test000018::setUp()
{
...
void test000018::tearDown()
{
  delete CCopasiRootContainer::Root;
  CCopasiRootContainer::Root = NULL;
}

void test000018::test_references_to_species()
{
  // load the CPS file
  // export to SBML
  // check the resulting SBML model
  CCopasiDataModel* pDataModel = pCOPASIDATAMODEL;
  std::istringstream iss(test000018::MODEL_STRING);
  ...
  CPPUNIT_ASSERT(pSpecies->getHasOnlySubstanceUnits() == true);
  // there are two rules, one rule is for the compartment
  ...
  CPPUNIT_ASSERT(fabs((pFactor->getValue() - (AVOGADRO / 1e6)) / (AVOGADRO / 1e6)) < 1e-3);
...
const char* test000018::MODEL_STRING =
  "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
  "<!-- generated with COPASI 4.3.25 (Debug) (http://www.copasi.org) at 2008-02-15 09:45:35 UTC -->\n"
  ...
  "<p>Model with variable volume compartment, micromol quantity units and a reference to the species transient amount.</p>\n"
  "<p>On export this should create an SBML file with the hasOnlySubstanceUnits flag on the species set.</p>\n"
  "<p>The reference in the rule should be multiplied by a factor (6.023e17) and the references in the reactions should be divided by the volume.</p>\n"
  "</body></html>\n"
  "    </Comment>\n"
  "    <ListOfCompartments>\n"
  ...
  "      0 4.21549905e+18 4.215499050000001e+17 7 4.21549905e+18\n"
  "    </InitialState>\n"
  "  </Model>\n"
  "  <ListOfTasks>\n"
