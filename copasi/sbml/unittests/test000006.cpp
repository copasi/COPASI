// Begin CVS Header
//   $Source: /Volumes/Home/Users/shoops/cvs/copasi_dev/copasi/sbml/unittests/test000006.cpp,v $
//   $Revision: 1.5 $
//   $Name:  $
//   $Author: gauges $
...
CCopasiDataModel* test000006::pCOPASIDATAMODEL = NULL;

void test000006::setUp()
{
...
void test000006::tearDown()
{
  CCopasiRootContainer::destroy();
}

void test000006::test_references_to_species()
{
  // load the CPS file
  // export to SBML
  // check the resulting SBML model
  CCopasiDataModel* pDataModel = pCOPASIDATAMODEL;
  std::istringstream iss(test000006::MODEL_STRING);
...
const char* test000006::MODEL_STRING =
  "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
  "<!-- generated with COPASI 4.3.25 (Debug) (http://www.copasi.org) at 2008-02-15 09:31:22 UTC -->\n"
  ...
  "<p>Model with constant volume compartment,# quantity units and a reference to the species initial concentration.</p>\n"
