...
CCopasiDataModel* test000009::pCOPASIDATAMODEL = NULL;

void test000009::setUp()
{
...
const char* test000009::MODEL_STRING =
  ...
  "<!-- generated with COPASI 4.3.25 (Debug) (http://www.copasi.org) at 2008-02-15 09:34:28 UTC -->\n"
  ...
  "<p>Model with variable volume compartment, mmol quantity units and a reference to the species transient concentration.</p>\n"
  "<p>On export this should create an SBML file with the hasOnlySubstanceUnits flag on the species set. </p>\n"
  "<p>The reference in the rule should be divided by the volume. The references in the reactions should also be divided by the volume.</p>\n"
  "</body></html>\n"
  "    </Comment>\n"
  "    <ListOfCompartments>\n"
