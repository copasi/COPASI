// Begin CVS Header
//   $Source: /Volumes/Home/Users/shoops/cvs/copasi_dev/copasi/sbml/unittests/test000022.cpp,v $
//   $Revision: 1.3 $
//   $Name:  $
//   $Author: gauges $
...
CCopasiDataModel* test000022::pCOPASIDATAMODEL = NULL;

void test000022::setUp()
{
...
void test000022::tearDown()
{
  delete CCopasiRootContainer::Root;
  CCopasiRootContainer::Root = NULL;
}

void test000022::test_hasOnlySubstanceUnits()
{
...
const char* test000022::MODEL_STRING =
