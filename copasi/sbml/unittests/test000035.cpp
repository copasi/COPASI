...
CCopasiDataModel* test000035::pCOPASIDATAMODEL = NULL;

void test000035::setUp()
{
...
void test000035::tearDown()
{
  delete CCopasiRootContainer::Root;
  CCopasiRootContainer::Root = NULL;
}

void test000035::test_hasOnlySubstanceUnits()
{
...
const char* test000035::MODEL_STRING =
