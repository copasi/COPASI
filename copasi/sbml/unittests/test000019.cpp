...
CCopasiDataModel* test000019::pCOPASIDATAMODEL = NULL;

void test000019::setUp()
{
...
void test000019::tearDown()
{
  delete CCopasiRootContainer::Root;
  CCopasiRootContainer::Root = NULL;
}

void test000019::test_references_to_species()
{
  // load the CPS file
  // export to SBML
  // check the resulting SBML model
  CCopasiDataModel* pDataModel = pCOPASIDATAMODEL;
  std::istringstream iss(test000019::MODEL_STRING);
...
const char* test000019::MODEL_STRING =
  ...
  "<!-- generated with COPASI 4.3.25 (Debug) (http://www.copasi.org) at 2008-02-15 09:47:04 UTC -->\n"
  ...
  "<p>Model with variable volume compartment, micromol quantity units and a reference to the species initial concentration.</p>\n"
  "<p>On export this should create an SBML file with the hasOnlySubstanceUnits flag on the species set.</p>\n"
  "<p>The reference to the species in the initial assignment should be divided by the volume. The references in the reactions should be divided by the volume.</p>\n"
  "</body></html>\n"
  "    </Comment>\n"
  "    <ListOfCompartments>\n"
