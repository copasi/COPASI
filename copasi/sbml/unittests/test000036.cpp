...
CCopasiDataModel* test000036::pCOPASIDATAMODEL = NULL;

void test000036::setUp()
{
...
void test000036::tearDown()
{
  delete CCopasiRootContainer::Root;
  CCopasiRootContainer::Root = NULL;
}

void test000036::test_hasOnlySubstanceUnits()
{
...
const char* test000036::MODEL_STRING =
  "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
  "<sbml xmlns=\"http://www.sbml.org/sbml/level2/version3\" level=\"2\" version=\"3\">\n"
  "    <notes>\n"
  "      <body xmlns=\"http://www.w3.org/1999/xhtml\">\n"
  "        <p>Model with fixed compartment volume, two species with hasOnlySubstanceUnits flag set to false. The units are set to ml and item. There is an initial assignment for the global parameter that contains a reference to species A.</p>\n"
  "        <p>The imported model should contain an initial assignment for the global parameter that consists of the reference to the initial concentration of species A. The species references in the reactions should be imported unmodified.</p>\n"
  "      </body>\n"
  "    </notes>\n"
