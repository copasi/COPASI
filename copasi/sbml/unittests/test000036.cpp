...
const char* test000036::MODEL_STRING =
  ...
  "        <p>The imported model should contain an initial assignment for the global parameter that consists of the reference to sthe concentration of pecies A. The species references in the reactions should be imported unmodified.</p>\n"
  "      </body>\n"
  "    </notes>\n"
