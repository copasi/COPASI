...
CCopasiDataModel* test000024::pCOPASIDATAMODEL = NULL;

void test000024::setUp()
{
...
void test000024::tearDown()
{
  delete CCopasiRootContainer::Root;
  CCopasiRootContainer::Root = NULL;
}

void test000024::test_hasOnlySubstanceUnits()
{
...
const char* test000024::MODEL_STRING =
  "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
  "<sbml xmlns=\"http://www.sbml.org/sbml/level2/version3\" level=\"2\" version=\"3\">\n"
  "  <model id=\"Model_1\" name=\"New Model\">\n"
  "    <notes>\n"
  "      <body xmlns=\"http://www.w3.org/1999/xhtml\">\n"
  "        <p>Model with fixed compartment volume, two species with hasOnlySubstanceUnits flag set to true. The units are set to ml and item. There is an assignment rule for the global parameter that contains a reference to species A.</p>\n"
  "        <p>The imported model should contain an assignment for the global parameter that consists of the reference to the particle number of species A divided by a constant. The species references in the reactions should be imported multiplied by the volume.</p>\n"
  "      </body>\n"
  "    </notes>\n"
