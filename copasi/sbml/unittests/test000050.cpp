...
void test000050::test_bug894()
{
  ...
  try
  ...
  catch (...)
    {
      ...
      s = message.getText();
      CPPUNIT_ASSERT(s.find(std::string("Call to function \"uniform\" used in mathematical expression for initial expression for object named \"K\" which can not be exported to SBML")) != std::string::npos);
      return;
    }
