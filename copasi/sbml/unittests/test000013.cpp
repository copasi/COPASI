...
CCopasiDataModel* test000013::pCOPASIDATAMODEL = NULL;

void test000013::setUp()
{
...
void test000013::tearDown()
{
  delete CCopasiRootContainer::Root;
  CCopasiRootContainer::Root = NULL;
}

void test000013::test_references_to_species()
{
  // load the CPS file
  // export to SBML
  // check the resulting SBML model
  CCopasiDataModel* pDataModel = pCOPASIDATAMODEL;
  std::istringstream iss(test000013::MODEL_STRING);
...
const char* test000013::MODEL_STRING =
  "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
  "<!-- generated with COPASI 4.3.25 (Debug) (http://www.copasi.org) at 2008-02-15 09:38:13 UTC -->\n"
  ...
  "<p>Model with variable volume compartment,mmol quantity units and a reference to the species initial concentration.</p>\n"
  "<p>On export this should create an SBML file with the hasOnlySubstanceUnits flag on the species set.</p>\n"
  "<p>The reference in the initial assignment should be divided by the volume. The references in the kinetic laws should be divided by the volume.</p>\n"
  "</body></html>\n"
  "    </Comment>\n"
  "    <ListOfCompartments>\n"
  ...
  "      0 4.215499050000001e+21 4.215499050000002e+20 7 1\n"
  "    </InitialState>\n"
  "  </Model>\n"
  "  <ListOfTasks>\n"
