// Begin CVS Header
//   $Source: /Volumes/Home/Users/shoops/cvs/copasi_dev/copasi/sbml/unittests/test000028.cpp,v $
//   $Revision: 1.5 $
//   $Name:  $
//   $Author: shoops $
...
CCopasiDataModel* test000028::pCOPASIDATAMODEL = NULL;

void test000028::setUp()
{
...
void test000028::tearDown()
{
  delete CCopasiRootContainer::Root;
  CCopasiRootContainer::Root = NULL;
}

void test000028::test_hasOnlySubstanceUnits()
{
...
const char* test000028::MODEL_STRING =
  "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
  "<sbml xmlns=\"http://www.sbml.org/sbml/level2/version3\" level=\"2\" version=\"3\">\n"
  "  <model id=\"Model_1\" name=\"New Model\">\n"
  "    <notes>\n"
  "      <body xmlns=\"http://www.w3.org/1999/xhtml\">\n"
  "        <p>Model with fixed compartment volume, two species with hasOnlySubstanceUnits flag set to false. The units are set to ml and mMol. There is a rate rule for the global parameter that contains a reference to species A.</p>\n"
  "        <p>The imported model should contain an rate rule for the global parameter that consists of the reference to the concentration of species A. The species references in the reactions should be imported unmodified.</p>\n"
  "      </body>\n"
  "    </notes>\n"
