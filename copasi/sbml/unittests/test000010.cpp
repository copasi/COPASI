...
CCopasiDataModel* test000010::pCOPASIDATAMODEL = NULL;

void test000010::setUp()
{
...
void test000010::tearDown()
{
  delete CCopasiRootContainer::Root;
  CCopasiRootContainer::Root = NULL;
}

void test000010::test_references_to_species()
{
  // load the CPS file
  // export to SBML
  // check the resulting SBML model
  CCopasiDataModel* pDataModel = pCOPASIDATAMODEL;
  std::istringstream iss(test000010::MODEL_STRING);
...
const char* test000010::MODEL_STRING =
  "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
  "<!-- generated with COPASI 4.3.25 (Debug) (http://www.copasi.org) at 2008-02-15 10:01:28 UTC -->\n"
  ...
  "<p>Model with variable volume compartment,# quantity units and a reference to the species transient concentration.</p>\n"
  "<p>On export this should create an SBML file with the hasOnlySubstanceUnits flag on the species set. </p>\n"
  "<p>The reference in the rule should be divided by the volume. The references in the reactions should be divided by the volume.</p>\n"
  "</body></html>\n"
  "    </Comment>\n"
  "    <ListOfCompartments>\n"
