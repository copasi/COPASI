...
CDataModel* test000030::pCOPASIDATAMODEL = NULL;
...
const char* test000030::MODEL_STRING =
  ...
  "        <p>Model with fixed compartment volume, two species with hasOnlySubstanceUnits flag set to true. The units are set to ml and mMol. There is an rate rule for the global parameter that contains a reference to species A multiplied by a constant.</p>\n"
