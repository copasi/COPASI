...
const INCOMPATIBILITY Incompatibilities[] =
  {
    ...
    {3, 0, 0, SBMLIncompatibility::WARNING, "SBMLIncompatibility (3): Species \"%s\" is defined via an ODE Rule and it is located in a compartment with a non-fixed volume."
