 ...
 **
 ** Created: Wed Mar 7 15:22:39 2007
 **      by: The User Interface Compiler ($Id: CQFittingItemWidget.cpp,v 1.20 2007/03/07 20:28:20 shoops Exp $)
 **
    ...
    : QWidget(parent, name, fl)
{
  ...
  layout18 = new QGridLayout(0, 1, 1, 0, 0, "layout18");

  mpLblCrossValidations = new QLabel(this, "mpLblCrossValidations");

  layout18->addMultiCellWidget(mpLblCrossValidations, 5, 5, 0, 2);
  mpSpacer3 = new QSpacerItem(16, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);
  layout18->addItem(mpSpacer3, 2, 4);

  mpCheckLowerInf = new QCheckBox(this, "mpCheckLowerInf");
  mpCheckLowerInf->setChecked(TRUE);

  layout18->addWidget(mpCheckLowerInf, 1, 2);

  mpBtnDel = new QToolButton(this, "mpBtnDel");
  mpBtnDel->setMaximumSize(QSize(20, 20));
  mpBtnDel->setIconSet(QIconSet(image0));

  layout18->addWidget(mpBtnDel, 1, 5);

  mpLblStart = new QLabel(this, "mpLblStart");

  layout18->addMultiCellWidget(mpLblStart, 3, 3, 0, 1);

  mpBtnUp = new QToolButton(this, "mpBtnUp");
  mpBtnUp->setMaximumSize(QSize(20, 20));
  mpBtnUp->setIconSet(QIconSet(image1));

  layout18->addWidget(mpBtnUp, 0, 6);
  ...
  mpBtnUpperEdit->setIconSet(QIconSet(image2));
  mpLayoutUpper->addWidget(mpBtnUpperEdit);

  layout18->addLayout(mpLayoutUpper, 2, 3);
  mpSpacer2 = new QSpacerItem(16, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);
  layout18->addItem(mpSpacer2, 1, 4);

  mpBtnNew = new QToolButton(this, "mpBtnNew");
  mpBtnNew->setMaximumSize(QSize(20, 20));
  mpBtnNew->setIconSet(QIconSet(image3));

  layout18->addWidget(mpBtnNew, 0, 5);

  mpLblUpper = new QLabel(this, "mpLblUpper");

  layout18->addMultiCellWidget(mpLblUpper, 2, 2, 0, 1);
  mpSpacer1 = new QSpacerItem(16, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);
  layout18->addItem(mpSpacer1, 0, 4);

  mpBtnDown = new QToolButton(this, "mpBtnDown");
  mpBtnDown->setMaximumSize(QSize(20, 20));
  mpBtnDown->setIconSet(QIconSet(image4));

  layout18->addWidget(mpBtnDown, 1, 6);

  mpLblLower = new QLabel(this, "mpLblLower");

  layout18->addWidget(mpLblLower, 1, 0);

  mpLblExperiments = new QLabel(this, "mpLblExperiments");

  layout18->addMultiCellWidget(mpLblExperiments, 4, 4, 0, 2);
  mpSpacerLeft = new QSpacerItem(16, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);
  layout18->addItem(mpSpacerLeft, 1, 1);

  mpBtnCopy = new QToolButton(this, "mpBtnCopy");
  mpBtnCopy->setMaximumSize(QSize(20, 20));
  mpBtnCopy->setIconSet(QIconSet(image5));

  layout18->addWidget(mpBtnCopy, 2, 5);

  mpLayoutStart = new QHBoxLayout(0, 0, 6, "mpLayoutStart");

  mpEditStart = new QLineEdit(this, "mpEditStart");
  mpEditStart->setFrameShape(QLineEdit::LineEditPanel);
  mpEditStart->setFrameShadow(QLineEdit::Sunken);
  mpLayoutStart->addWidget(mpEditStart);

  mpBtnReset = new QToolButton(this, "mpBtnReset");
  mpBtnReset->setMaximumSize(QSize(20, 20));
  mpBtnReset->setIconSet(QIconSet(image6));
  mpLayoutStart->addWidget(mpBtnReset);

  layout18->addLayout(mpLayoutStart, 3, 3);
  ...
  mpBtnLowerEdit->setIconSet(QIconSet(image2));
  mpLayoutLower->addWidget(mpBtnLowerEdit);

  layout18->addLayout(mpLayoutLower, 1, 3);
  ...
  mpBtnExperiments->setIconSet(QIconSet(image6));
  mpLayoutExperiments->addWidget(mpBtnExperiments);

  layout18->addLayout(mpLayoutExperiments, 4, 3);

  mpLblObject = new QLabel(this, "mpLblObject");

  layout18->addMultiCellWidget(mpLblObject, 0, 0, 0, 2);

  mpLayoutCrossValidations = new QHBoxLayout(0, 0, 6, "mpLayoutCrossValidations");

  mpCheckCrossValidationsAll = new QCheckBox(this, "mpCheckCrossValidationsAll");
  mpCheckCrossValidationsAll->setChecked(TRUE);
  mpLayoutCrossValidations->addWidget(mpCheckCrossValidationsAll);

  mpBoxCrossValidations = new QComboBox(FALSE, this, "mpBoxCrossValidations");
  mpBoxCrossValidations->setEnabled(TRUE);
  mpBoxCrossValidations->setSizePolicy(QSizePolicy((QSizePolicy::SizeType)7, (QSizePolicy::SizeType)0, 0, 0, mpBoxCrossValidations->sizePolicy().hasHeightForWidth()));
  mpBoxCrossValidations->setDuplicatesEnabled(FALSE);
  mpLayoutCrossValidations->addWidget(mpBoxCrossValidations);

  mpBtnCrossValidations = new QToolButton(this, "mpBtnCrossValidations");
  mpBtnCrossValidations->setMaximumSize(QSize(20, 20));
  mpBtnCrossValidations->setIconSet(QIconSet(image6));
  mpLayoutCrossValidations->addWidget(mpBtnCrossValidations);

  layout18->addLayout(mpLayoutCrossValidations, 5, 3);

  mpCheckUpperInf = new QCheckBox(this, "mpCheckUpperInf");
  mpCheckUpperInf->setChecked(TRUE);

  layout18->addWidget(mpCheckUpperInf, 2, 2);
  ...
  mpBtnObject->setIconSet(QIconSet(image2));
  mpLayoutObject->addWidget(mpBtnObject);

  layout18->addLayout(mpLayoutObject, 0, 3);
  CQFittingItemWidgetLayout->addLayout(layout18);

  mpBtnPerExperiment = new QPushButton(this, "mpBtnPerExperiment");
  CQFittingItemWidgetLayout->addWidget(mpBtnPerExperiment);
  languageChange();
  resize(QSize(344, 248).expandedTo(minimumSizeHint()));
  ...
  connect(mpBtnReset, SIGNAL(clicked()), this, SLOT(slotReset()));
  connect(mpEditStart, SIGNAL(lostFocus()), this, SLOT(slotStartLostFocus()));
  connect(mpBtnCrossValidations, SIGNAL(clicked()), this, SLOT(slotCrossValidations()));
  connect(mpCheckCrossValidationsAll, SIGNAL(toggled(bool)), this, SLOT(slotCheckAllCrossValidations(bool)));

  // tab order
  setTabOrder(mpTable, mpEditObject);
  setTabOrder(mpEditObject, mpCheckLowerInf);
  setTabOrder(mpCheckLowerInf, mpEditLower);
  setTabOrder(mpEditLower, mpCheckUpperInf);
  setTabOrder(mpCheckUpperInf, mpEditUpper);
  setTabOrder(mpEditUpper, mpEditStart);
  setTabOrder(mpEditStart, mpCheckAll);
  setTabOrder(mpCheckAll, mpBoxExperiments);
  setTabOrder(mpBoxExperiments, mpCheckCrossValidationsAll);
  setTabOrder(mpCheckCrossValidationsAll, mpBoxCrossValidations);
  setTabOrder(mpBoxCrossValidations, mpBtnPerExperiment);
  init();
}
...
void CQFittingItemWidget::languageChange()
{
  ...
  mpBtnReset->setText(QString::null);
  mpBtnReset->setTextLabel(tr("reset"));
  ...
  mpCheckCrossValidationsAll->setText(tr("all"));
  mpBtnCrossValidations->setText(QString::null);
