...
public:
  ...
  void setupUi(QWidget *CQTSSAResultSubWidget)
  {
    ...
    QSizePolicy sizePolicy2(static_cast<QSizePolicy::Policy>(2), static_cast<QSizePolicy::Policy>(7));
    ...
    QSizePolicy sizePolicy3(static_cast<QSizePolicy::Policy>(7), static_cast<QSizePolicy::Policy>(1));
    sizePolicy3.setHorizontalStretch(0);
    sizePolicy3.setVerticalStretch(0);
    sizePolicy3.setHeightForWidth(mSlider->sizePolicy().hasHeightForWidth());
    mSlider->setSizePolicy(sizePolicy3);
    ...
    sizePolicy4.setHeightForWidth(mLabel7->sizePolicy().hasHeightForWidth());
    mLabel7->setSizePolicy(sizePolicy4);
    ...
    sizePolicy5.setHeightForWidth(pLabel1->sizePolicy().hasHeightForWidth());
    pLabel1->setSizePolicy(sizePolicy5);
    ...
    sizePolicy4.setHeightForWidth(mLabel2->sizePolicy().hasHeightForWidth());
    mLabel2->setSizePolicy(sizePolicy4);
    QFont font;
    font.setBold(true);
    ...
    sizePolicy5.setHeightForWidth(mLabel3->sizePolicy().hasHeightForWidth());
    mLabel3->setSizePolicy(sizePolicy5);
    ...
    sizePolicy4.setHeightForWidth(mLabel4->sizePolicy().hasHeightForWidth());
    mLabel4->setSizePolicy(sizePolicy4);
    ...
    sizePolicy5.setHeightForWidth(mLabel5->sizePolicy().hasHeightForWidth());
    mLabel5->setSizePolicy(sizePolicy5);
    ...
    sizePolicy4.setHeightForWidth(mLabel6->sizePolicy().hasHeightForWidth());
    mLabel6->setSizePolicy(sizePolicy4);
    ...
    sizePolicy2.setHeightForWidth(mTabWidget->sizePolicy().hasHeightForWidth());
    mTabWidget->setSizePolicy(sizePolicy2);
    tab2 = new QWidget();
    ...
    gridLayout6 = new QGridLayout(TabPage2);
    ...
    gridLayout9->addWidget(pArrayWidgetTMP3, 0, 0, 1, 1);
    ...
    gridLayout10 = new QGridLayout(TabPage_ILDMM);
    ...
    sizePolicy5.setHeightForWidth(pLabel1_6->sizePolicy().hasHeightForWidth());
    pLabel1_6->setSizePolicy(sizePolicy5);
    pLabel1_6->setWordWrap(false);

    gridLayout10->addWidget(pLabel1_6, 0, 0, 1, 1);

    mLabel6_6 = new QLabel(TabPage_ILDMM);
    mLabel6_6->setObjectName(QString::fromUtf8("mLabel6_6"));
    sizePolicy4.setHeightForWidth(mLabel6_6->sizePolicy().hasHeightForWidth());
    mLabel6_6->setSizePolicy(sizePolicy4);
    mLabel6_6->setWordWrap(false);

    gridLayout10->addWidget(mLabel6_6, 0, 5, 1, 1);

    mLabel4_6 = new QLabel(TabPage_ILDMM);
    mLabel4_6->setObjectName(QString::fromUtf8("mLabel4_6"));
    sizePolicy4.setHeightForWidth(mLabel4_6->sizePolicy().hasHeightForWidth());
    mLabel4_6->setSizePolicy(sizePolicy4);
    mLabel4_6->setFont(font);
    mLabel4_6->setWordWrap(false);

    gridLayout10->addWidget(mLabel4_6, 0, 3, 1, 1);

    mLabel2_6 = new QLabel(TabPage_ILDMM);
    mLabel2_6->setObjectName(QString::fromUtf8("mLabel2_6"));
    sizePolicy4.setHeightForWidth(mLabel2_6->sizePolicy().hasHeightForWidth());
    mLabel2_6->setSizePolicy(sizePolicy4);
    mLabel2_6->setFont(font);
    mLabel2_6->setWordWrap(false);

    gridLayout10->addWidget(mLabel2_6, 0, 1, 1, 1);

    mLabel3_6 = new QLabel(TabPage_ILDMM);
    mLabel3_6->setObjectName(QString::fromUtf8("mLabel3_6"));
    sizePolicy5.setHeightForWidth(mLabel3_6->sizePolicy().hasHeightForWidth());
    mLabel3_6->setSizePolicy(sizePolicy5);
    mLabel3_6->setWordWrap(false);

    gridLayout10->addWidget(mLabel3_6, 0, 2, 1, 1);

    mSpacer_6 = new QSpacerItem(309, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

    gridLayout10->addItem(mSpacer_6, 0, 6, 1, 1);

    mLabel5_6 = new QLabel(TabPage_ILDMM);
    mLabel5_6->setObjectName(QString::fromUtf8("mLabel5_6"));
    sizePolicy5.setHeightForWidth(mLabel5_6->sizePolicy().hasHeightForWidth());
    mLabel5_6->setSizePolicy(sizePolicy5);
    mLabel5_6->setWordWrap(false);

    gridLayout10->addWidget(mLabel5_6, 0, 4, 1, 1);

    mSlider_4 = new QSlider(TabPage_ILDMM);
    mSlider_4->setObjectName(QString::fromUtf8("mSlider_4"));
    sizePolicy3.setHeightForWidth(mSlider_4->sizePolicy().hasHeightForWidth());
    mSlider_4->setSizePolicy(sizePolicy3);
    ...
    gridLayout10->addWidget(mSlider_4, 1, 0, 1, 7);
    ...
    gridLayout11 = new QGridLayout(tab4);
    ...
    gridLayout11->addWidget(pArrayWidget_5, 0, 0, 1, 1);

    mTabWidget_4->addTab(tab4, QString());
    tab5 = new QWidget();
    tab5->setObjectName(QString::fromUtf8("tab5"));
    gridLayout12 = new QGridLayout(tab5);
    ...
    sizePolicy2.setHeightForWidth(mTabWidget_3->sizePolicy().hasHeightForWidth());
    mTabWidget_3->setSizePolicy(sizePolicy2);
    tab6 = new QWidget();
    tab6->setObjectName(QString::fromUtf8("tab6"));
    gridLayout16 = new QGridLayout(tab6);
    ...
    gridLayout16->addWidget(pArrayWidget_3, 0, 0, 1, 1);

    mTabWidget_3->addTab(tab6, QString());
    tab7 = new QWidget();
    tab7->setObjectName(QString::fromUtf8("tab7"));
    gridLayout17 = new QGridLayout(tab7);
    ...
    gridLayout23->addWidget(pArrayWidgetNIIr, 0, 0, 1, 1);

    mTabWidget_3->addTab(TabPage13, QString());

    gridLayout15->addWidget(mTabWidget_3, 2, 0, 1, 7);

    pLabel1_3 = new QLabel(TabPage_CSP);
    pLabel1_3->setObjectName(QString::fromUtf8("pLabel1_3"));
    sizePolicy5.setHeightForWidth(pLabel1_3->sizePolicy().hasHeightForWidth());
    pLabel1_3->setSizePolicy(sizePolicy5);
    pLabel1_3->setWordWrap(false);

    gridLayout15->addWidget(pLabel1_3, 0, 0, 1, 1);

    mLabel2_3 = new QLabel(TabPage_CSP);
    mLabel2_3->setObjectName(QString::fromUtf8("mLabel2_3"));
    sizePolicy4.setHeightForWidth(mLabel2_3->sizePolicy().hasHeightForWidth());
    mLabel2_3->setSizePolicy(sizePolicy4);
    mLabel2_3->setFont(font);
    mLabel2_3->setWordWrap(false);

    gridLayout15->addWidget(mLabel2_3, 0, 1, 1, 1);

    mLabel3_3 = new QLabel(TabPage_CSP);
    mLabel3_3->setObjectName(QString::fromUtf8("mLabel3_3"));
    sizePolicy5.setHeightForWidth(mLabel3_3->sizePolicy().hasHeightForWidth());
    mLabel3_3->setSizePolicy(sizePolicy5);
    mLabel3_3->setWordWrap(false);

    gridLayout15->addWidget(mLabel3_3, 0, 2, 1, 1);

    mLabel4_3 = new QLabel(TabPage_CSP);
    mLabel4_3->setObjectName(QString::fromUtf8("mLabel4_3"));
    sizePolicy4.setHeightForWidth(mLabel4_3->sizePolicy().hasHeightForWidth());
    mLabel4_3->setSizePolicy(sizePolicy4);
    mLabel4_3->setFont(font);
    mLabel4_3->setWordWrap(false);

    gridLayout15->addWidget(mLabel4_3, 0, 3, 1, 1);

    mLabel5_3 = new QLabel(TabPage_CSP);
    mLabel5_3->setObjectName(QString::fromUtf8("mLabel5_3"));
    sizePolicy5.setHeightForWidth(mLabel5_3->sizePolicy().hasHeightForWidth());
    mLabel5_3->setSizePolicy(sizePolicy5);
    mLabel5_3->setWordWrap(false);

    gridLayout15->addWidget(mLabel5_3, 0, 4, 1, 1);

    mLabel6_3 = new QLabel(TabPage_CSP);
    mLabel6_3->setObjectName(QString::fromUtf8("mLabel6_3"));
    sizePolicy4.setHeightForWidth(mLabel6_3->sizePolicy().hasHeightForWidth());
    mLabel6_3->setSizePolicy(sizePolicy4);
    mLabel6_3->setWordWrap(false);

    gridLayout15->addWidget(mLabel6_3, 0, 5, 1, 1);

    mSpacer_3 = new QSpacerItem(181, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

    gridLayout15->addItem(mSpacer_3, 0, 6, 1, 1);

    mSlider_3 = new QSlider(TabPage_CSP);
    mSlider_3->setObjectName(QString::fromUtf8("mSlider_3"));
    sizePolicy3.setHeightForWidth(mSlider_3->sizePolicy().hasHeightForWidth());
    mSlider_3->setSizePolicy(sizePolicy3);
    ...
    gridLayout15->addWidget(mSlider_3, 1, 0, 1, 7);
