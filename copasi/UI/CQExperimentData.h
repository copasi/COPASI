...
class Ui_CQExperimentData
  ...
  public:
    ...
    void setupUi(QDialog *CQExperimentData)
    {
      ...
      vboxLayout = new Q3VBoxLayout(CQExperimentData);
      ...
      mpLineCrossValidation = new Q3Frame(CQExperimentData);
      mpLineCrossValidation->setObjectName(QString::fromUtf8("mpLineCrossValidation"));
      mpLineCrossValidation->setFrameShape(Q3Frame::HLine);
      mpLineCrossValidation->setFrameShadow(Q3Frame::Sunken);
      ...
      mpLine = new Q3Frame(CQExperimentData);
      ...
      hboxLayout1 = new Q3HBoxLayout(mpBtnGroup->layout());
