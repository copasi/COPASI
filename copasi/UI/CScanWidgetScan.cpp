 ...
 **      by: The User Interface Compiler ($Id: CScanWidgetScan.cpp,v 1.5.26.1 2008/07/31 23:10:16 shoops Exp $)
 **
    ...
    : QWidget(parent, name, fl)
{
  ...
  CScanWidgetScanLayout = new QVBoxLayout(this, 5, 6, "CScanWidgetScanLayout");
  ...
  CScanWidgetScanLayout->addWidget(frame);
  languageChange();
  resize(QSize(372, 143).expandedTo(minimumSizeHint()));
