...
class Ui_CQCompartment
  ...
  public:
    ...
    void setupUi(CopasiWidget *CQCompartment)
    {
      ...
      gridLayout = new Q3GridLayout(CQCompartment);
      ...
      gridLayout->addLayout(hboxLayout, 11, 0, 1, 3);
      ...
      gridLayout->addWidget(mpLblMetabolites, 8, 0, 2, 1);
      ...
      gridLayout->addWidget(mpLblVolume, 6, 0, 1, 1);
      ...
      gridLayout->addWidget(mpEditCurrentVolume, 6, 1, 1, 1);
      ...
      mpLine1 = new Q3Frame(CQCompartment);
      ...
      gridLayout->addWidget(mpEditInitialVolume, 3, 1, 1, 1);
      ...
      gridLayout->addWidget(mpMetaboliteTable, 8, 1, 1, 2);

      mpSpacer = new QSpacerItem(20, 16, QSizePolicy::Minimum, QSizePolicy::Expanding);

      gridLayout->addItem(mpSpacer, 9, 1, 1, 1);
