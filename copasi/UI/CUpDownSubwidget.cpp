    ...
    : QWidget(parent, name, fl)
{
  ...
  CUpDownSubwidgetLayout = new QVBoxLayout(this, 3, 0, "CUpDownSubwidgetLayout");

  layout6 = new QGridLayout(0, 1, 1, 0, 6, "layout6");

  toolButtonDel = new QToolButton(this, "toolButtonDel");
  toolButtonDel->setMaximumSize(QSize(20, 20));
  toolButtonDel->setIconSet(QIconSet(image0));

  layout6->addWidget(toolButtonDel, 0, 0);

  toolButtonUp = new QToolButton(this, "toolButtonUp");
  toolButtonUp->setMaximumSize(QSize(20, 20));
  toolButtonUp->setIconSet(QIconSet(image1));

  layout6->addWidget(toolButtonUp, 0, 1);

  toolButtonCopy = new QToolButton(this, "toolButtonCopy");
  toolButtonCopy->setMaximumSize(QSize(20, 20));
  toolButtonCopy->setIconSet(QIconSet(image2));

  layout6->addWidget(toolButtonCopy, 1, 0);

  toolButtonDown = new QToolButton(this, "toolButtonDown");
  toolButtonDown->setMaximumSize(QSize(20, 20));
  toolButtonDown->setIconSet(QIconSet(image3));

  layout6->addWidget(toolButtonDown, 1, 1);
  CUpDownSubwidgetLayout->addLayout(layout6);
  spacer = new QSpacerItem(20, 6, QSizePolicy::Minimum, QSizePolicy::Expanding);
  CUpDownSubwidgetLayout->addItem(spacer);
  languageChange();
  resize(QSize(120, 52).expandedTo(minimumSizeHint()));
  ...
  connect(toolButtonCopy, SIGNAL(clicked()), this, SLOT(slotCopy()));
  init();
}
...
void CUpDownSubwidget::languageChange()
{
  ...
  toolButtonCopy->setText(QString::null);
