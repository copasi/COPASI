 ...
 **
 ** Created: Mon Nov 20 10:24:15 2006
 **      by: The User Interface Compiler ($Id: CQFittingResultTab1.cpp,v 1.3 2006/11/20 16:39:12 shoops Exp $)
 **
    ...
    : QWidget(parent, name, fl)
{
  ...
  mpLayoutGrid->addWidget(mpEditEvaluations, 5, 0);

  mpLblCPUTime = new QLabel(this, "mpLblCPUTime");

  mpLayoutGrid->addWidget(mpLblCPUTime, 4, 1);

  mpLblCVObjectiveValue = new QLabel(this, "mpLblCVObjectiveValue");

  mpLayoutGrid->addWidget(mpLblCVObjectiveValue, 2, 0);

  mpLblCVStdDeviation = new QLabel(this, "mpLblCVStdDeviation");

  mpLayoutGrid->addWidget(mpLblCVStdDeviation, 2, 2);

  mpLblStdDeviation = new QLabel(this, "mpLblStdDeviation");

  mpLayoutGrid->addWidget(mpLblStdDeviation, 0, 2);

  mpLblCVRMS = new QLabel(this, "mpLblCVRMS");

  mpLayoutGrid->addWidget(mpLblCVRMS, 2, 1);

  mpLblEvaluations = new QLabel(this, "mpLblEvaluations");

  mpLayoutGrid->addWidget(mpLblEvaluations, 4, 0);

  mpEditSpeed = new QLineEdit(this, "mpEditSpeed");
  mpEditSpeed->setReadOnly(TRUE);

  mpLayoutGrid->addWidget(mpEditSpeed, 5, 2);
  ...
  mpLayoutGrid->addWidget(mpEditCPUTime, 5, 1);

  mpEditCVObjectiveValue = new QLineEdit(this, "mpEditCVObjectiveValue");
  mpEditCVObjectiveValue->setReadOnly(TRUE);

  mpLayoutGrid->addWidget(mpEditCVObjectiveValue, 3, 0);

  mpLblObjectiveValue = new QLabel(this, "mpLblObjectiveValue");

  mpLayoutGrid->addWidget(mpLblObjectiveValue, 0, 0);

  mpEditCVRMS = new QLineEdit(this, "mpEditCVRMS");
  mpEditCVRMS->setFrameShape(QLineEdit::LineEditPanel);
  mpEditCVRMS->setFrameShadow(QLineEdit::Sunken);
  mpEditCVRMS->setReadOnly(TRUE);

  mpLayoutGrid->addWidget(mpEditCVRMS, 3, 1);

  mpEditCVStdDeviation = new QLineEdit(this, "mpEditCVStdDeviation");
  mpEditCVStdDeviation->setReadOnly(TRUE);

  mpLayoutGrid->addWidget(mpEditCVStdDeviation, 3, 2);
  ...
  mpLayoutGrid->addWidget(mpLblSpeed, 4, 2);
  ...
  languageChange();
  resize(QSize(362, 264).expandedTo(minimumSizeHint()));
...
void CQFittingResultTab1::languageChange()
{
  ...
  mpLblCVObjectiveValue->setText(tr("CV Objective Value"));
  mpLblCVStdDeviation->setText(tr("CV Standard Deviation"));
  mpLblStdDeviation->setText(tr("Standard Deviation"));
  mpLblCVRMS->setText(tr("CV Root Mean Square"));
