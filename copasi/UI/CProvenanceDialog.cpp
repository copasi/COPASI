...
CProvenanceDialog::CProvenanceDialog(QWidget* parent, QUndoStack *undoStack, QString PathFile ,  QList<QString> VersionsPathToCurrentModel) //, const char* name, bool modal, Qt::WindowFlags fl)
  : QDialog(parent)
{
  setupUi(this);
