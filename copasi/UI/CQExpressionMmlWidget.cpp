 ...
 **
 ** Created: Thu Nov 13 10:42:31 2008
 **      by: The User Interface Compiler ($Id: CQExpressionMmlWidget.cpp,v 1.4.4.1 2008/11/13 17:04:14 shoops Exp $)
 **
    ...
    : QWidget(parent, name, fl)
{
  ...
  mpMmlPageLayout = new QHBoxLayout(mpMmlPage, 0, 6, "mpMmlPageLayout");

  mpMmlScrollView = new CQMmlScrollView(mpMmlPage, "mpMmlScrollView");
  mpMmlPageLayout->addWidget(mpMmlScrollView);
  ...
  layout5->addWidget(mpBtnEditExpression);

  mpBtnSaveExpression = new QToolButton(mpMmlPage, "mpBtnSaveExpression");
  mpBtnSaveExpression->setMaximumSize(QSize(20, 20));
  mpBtnSaveExpression->setIconSet(QIconSet(image3));
  layout5->addWidget(mpBtnSaveExpression);
  mpSpacerMmlObject = new QSpacerItem(20, 50, QSizePolicy::Minimum, QSizePolicy::Expanding);
  layout5->addItem(mpSpacerMmlObject);
  mpMmlPageLayout->addLayout(layout5);
  ...
  connect(mpBtnSaveExpression, SIGNAL(clicked()), this, SLOT(slotSaveExpression()));
  init();
}
...
void CQExpressionMmlWidget::languageChange()
{
  ...
  mpBtnSaveExpression->setText(QString::null);
  QToolTip::add(mpBtnSaveExpression, tr("save expression"));
}
