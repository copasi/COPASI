...
class Ui_CQFittingItemWidget
  ...
  public:
    ...
    void setupUi(QWidget *CQFittingItemWidget)
    {
      ...
      CQFittingItemWidget->resize(344, 248);
      ...
      vboxLayout = new Q3VBoxLayout(CQFittingItemWidget);
      vboxLayout->setSpacing(6);
      vboxLayout->setMargin(1);
      vboxLayout->setObjectName(QString::fromUtf8("vboxLayout"));
      mpTable = new Q3Table(CQFittingItemWidget);
      ...
      mpTable->setSelectionMode(Q3Table::MultiRow);
      ...
      gridLayout->addWidget(mpLblCrossValidations, 5, 0, 1, 3);

      mpSpacer3 = new QSpacerItem(16, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);

      gridLayout->addItem(mpSpacer3, 2, 4, 1, 1);
      ...
      gridLayout->addWidget(mpCheckLowerInf, 1, 2, 1, 1);
      ...
      gridLayout->addWidget(mpBtnDel, 1, 5, 1, 1);
      ...
      gridLayout->addWidget(mpBtnUp, 0, 6, 1, 1);
      ...
      hboxLayout->addWidget(mpEditUpper);
      ...
      gridLayout->addWidget(mpBtnNew, 0, 5, 1, 1);
      ...
      gridLayout->addWidget(mpLblUpper, 2, 0, 1, 2);

      mpSpacer1 = new QSpacerItem(16, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);

      gridLayout->addItem(mpSpacer1, 0, 4, 1, 1);
      ...
      gridLayout->addWidget(mpBtnDown, 1, 6, 1, 1);
      ...
      gridLayout->addWidget(mpLblExperiments, 4, 0, 1, 3);

      mpSpacerLeft = new QSpacerItem(16, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);

      gridLayout->addItem(mpSpacerLeft, 1, 1, 1, 1);
      ...
      gridLayout->addWidget(mpBtnCopy, 2, 5, 1, 1);
      ...
      hboxLayout1->addWidget(mpEditStart);
      ...
      hboxLayout1->addWidget(mpBtnReset);

      gridLayout->addLayout(hboxLayout1, 3, 3, 1, 1);
      ...
      hboxLayout2->addWidget(mpEditLower);
      ...
      hboxLayout2->addWidget(mpBtnLowerEdit);

      gridLayout->addLayout(hboxLayout2, 1, 3, 1, 1);
      ...
      hboxLayout3->addWidget(mpCheckAll);
      ...
      hboxLayout3->addWidget(mpBoxExperiments);
      ...
      hboxLayout3->addWidget(mpBtnExperiments);

      gridLayout->addLayout(hboxLayout3, 4, 3, 1, 1);
      ...
      gridLayout->addWidget(mpLblObject, 0, 0, 1, 3);
      ...
      hboxLayout4->addWidget(mpCheckCrossValidationsAll);
      ...
      hboxLayout4->addWidget(mpBoxCrossValidations);
      ...
      hboxLayout4->addWidget(mpBtnCrossValidations);

      gridLayout->addLayout(hboxLayout4, 5, 3, 1, 1);
      ...
      gridLayout->addWidget(mpCheckUpperInf, 2, 2, 1, 1);
      ...
      hboxLayout5->addWidget(mpEditObject);
      ...
      hboxLayout5->addWidget(mpBtnObject);

      gridLayout->addLayout(hboxLayout5, 0, 3, 1, 1);
      ...
      vboxLayout->addWidget(mpBtnPerExperiment);

      QWidget::setTabOrder(mpTable, mpEditObject);
      QWidget::setTabOrder(mpEditObject, mpCheckLowerInf);
      QWidget::setTabOrder(mpCheckLowerInf, mpEditLower);
      QWidget::setTabOrder(mpEditLower, mpCheckUpperInf);
      QWidget::setTabOrder(mpCheckUpperInf, mpEditUpper);
      QWidget::setTabOrder(mpEditUpper, mpEditStart);
      QWidget::setTabOrder(mpEditStart, mpCheckAll);
      ...
      QObject::connect(mpTable, SIGNAL(selectionChanged()), CQFittingItemWidget, SLOT(slotSelectionChanged()));
      QObject::connect(mpEditLower, SIGNAL(lostFocus()), CQFittingItemWidget, SLOT(slotLowerLostFocus()));
      QObject::connect(mpEditUpper, SIGNAL(lostFocus()), CQFittingItemWidget, SLOT(slotUpperLostFocus()));
      QObject::connect(mpBtnReset, SIGNAL(clicked()), CQFittingItemWidget, SLOT(slotReset()));
      QObject::connect(mpEditStart, SIGNAL(lostFocus()), CQFittingItemWidget, SLOT(slotStartLostFocus()));
