...
void test_normalform::test_nested_stepwise_fractions_3levels()
{
  ...
  // 01: 1 0 1 0 1 0   (2 == T) & (4 == A) & (6.2 == 2*T^(3J)) & (D == F) & (A  < PI) & (SIN (D*PI) < X)
  // 02: 0 0 1 0 1 0   (2 == T) & (4 == A) & (6.2 == 2*T^(3J)) & (D == F) & (SIN (D*PI) < X) & (PI <= A)
  // 03: 1 0 1 1 1 0   (2 == T) & (4 == A) & (6.2 == 2*T^(3J)) & (D != F) & (A  < PI) & (SIN (D*PI) < X)
  // 04: 0 0 1 1 1 0   (2 == T) & (4 == A) & (6.2 == 2*T^(3J)) & (D != F) & (SIN (D*PI) < X) & (PI <= A)
  // 05: 1 0 1 0 1 1   (2 == T) & (4 == A) & (D == F) & (6.2 != 2*T^(3J)) & (A  < PI) & (SIN (D*PI) < X)
  // 06: 1 0 1 0 0 1   (2 == T) & (4 == A) & (D == F) & (6.2 != 2*T^(3J)) & (A  < PI) & (X <= SIN(D*PI))
  // 07: 0 0 1 0 1 1   (2 == T) & (4 == A) & (D == F) & (6.2 != 2*T^(3J)) & (SIN (D*PI) < X) & (PI <= A)
  // 08: 0 0 1 0 0 1   (2 == T) & (4 == A) & (D == F) & (6.2 != 2*T^(3J)) & (PI <= A) & (X <= SIN(D*PI))
  // 09: 1 0 1 1 1 1   (2 == T) & (4 == A) & (6.2 != 2*T^(3J)) & (D != F) & (A  < PI) & (SIN (D*PI) < X)
  // 10: 1 0 1 1 0 1   (2 == T) & (4 == A) & (6.2 != 2*T^(3J)) & (D != F) & (A  < PI) & (X <= SIN(D*PI))
  // 11: 0 0 1 1 1 1   (2 == T) & (4 == A) & (6.2 != 2*T^(3J)) & (D != F) & (SIN (D*PI) < X) & (PI <= A)
  // 12: 0 0 1 1 0 1   (2 == T) & (4 == A) & (6.2 != 2*T^(3J)) & (D != F) & (PI <= A) & (X <= SIN(D*PI))
  // 13: 1 1 1 0 1 0   (2 == T) & (6.2 == 2*T^(3J)) & (D == F) & (4 != A) & (A  < PI) & (SIN (D*PI) < X)
  // 14: 1 1 1 1 1 0   (2 == T) & (6.2 == 2*T^(3J)) & (4 != A) & (D != F) & (A  < PI) & (SIN (D*PI) < X)
  // 15: 1 1 1 0 1 1   (2 == T) & (D == F) & (4 != A) & (6.2 != 2*T^(3J)) & (A  < PI) & (SIN (D*PI) < X)
  // 16: 1 1 1 0 0 1   (2 == T) & (D == F) & (4 != A) & (6.2 != 2*T^(3J)) & (A  < PI) & (X <= SIN(D*PI))
  // 17: 1 1 1 1 1 1   (2 == T) & (4 != A) & (6.2 != 2*T^(3J)) & (D != F) & (A  < PI) & (SIN (D*PI) < X)
  // 18: 1 1 1 1 0 1   (2 == T) & (4 != A) & (6.2 != 2*T^(3J)) & (D != F) & (A  < PI) & (X <= SIN(D*PI))
  // 19: 1 0 0 0 1 0   (4 == A) & (6.2 == 2*T^(3J)) & (D == F) & (2 != T) & (A  < PI) & (SIN (D*PI) < X)
  // 20: 0 0 0 0 1 0   (4 == A) & (6.2 == 2*T^(3J)) & (D == F) & (2 != T) & (SIN (D*PI) < X) & (PI <= A)
  // 21: 1 0 0 1 1 0   (4 == A) & (6.2 == 2*T^(3J)) & (2 != T) & (D != F) & (A  < PI) & (SIN (D*PI) < X)
  // 22: 0 0 0 1 1 0   (4 == A) & (6.2 == 2*T^(3J)) & (2 != T) & (D != F) & (SIN (D*PI) < X) & (PI <= A)
  // 23: 1 0 0 0 1 1   (4 == A) & (D == F) & (2 != T) & (6.2 != 2*T^(3J)) & (A  < PI) & (SIN (D*PI) < X)
  // 24: 1 0 0 0 0 1   (4 == A) & (D == F) & (2 != T) & (6.2 != 2*T^(3J)) & (A  < PI) & (X <= SIN(D*PI))
  // 25: 0 0 0 0 1 1   (4 == A) & (D == F) & (2 != T) & (6.2 != 2*T^(3J)) & (SIN (D*PI) < X) & (PI <= A)
  // 26: 0 0 0 0 0 1   (4 == A) & (D == F) & (2 != T) & (6.2 != 2*T^(3J)) & (PI <= A) & (X <= SIN(D*PI))
  // 27: 1 0 0 1 1 1   (4 == A) & (2 != T) & (6.2 != 2*T^(3J)) & (D != F) & (A  < PI) & (SIN (D*PI) < X)
  // 28: 1 0 0 1 0 1   (4 == A) & (2 != T) & (6.2 != 2*T^(3J)) & (D != F) & (A  < PI) & (X <= SIN(D*PI))
  // 29: 0 0 0 1 1 1   (4 == A) & (2 != T) & (6.2 != 2*T^(3J)) & (D != F) & (SIN (D*PI) < X) & (PI <= A)
  // 30: 0 0 0 1 0 1   (4 == A) & (2 != T) & (6.2 != 2*T^(3J)) & (D != F) & (PI <= A) & (X <= SIN(D*PI))
  // 31: 1 1 0 0 1 0   (6.2 == 2*T^(3J)) & (D == F) & (2 != T) & (4 != A) & (A  < PI) & (SIN (D*PI) < X)
  // 32: 1 1 0 1 1 0   (6.2 == 2*T^(3J)) & (2 != T) & (4 != A) & (D != F) & (A  < PI) & (SIN (D*PI) < X)
  // 33: 0 1 0 1 1 0   (6.2 == 2*T^(3J)) & (2 != T) & (4 != A) & (D != F) & (SIN (D*PI) < X) & (PI <= A)
  // 34: 0 1 0 1 0 0   (6.2 == 2*T^(3J)) & (2 != T) & (4 != A) & (D != F) & (PI <= A) & (X <= SIN(D*PI))
  // 35: 1 1 0 0 1 1   (D == F) & (2 != T) & (4 != A) & (6.2 != 2*T^(3J)) & (A  < PI) & (SIN (D*PI) < X)
  // 36: 1 1 0 0 0 1   (D == F) & (2 != T) & (4 != A) & (6.2 != 2*T^(3J)) & (A  < PI) & (X <= SIN(D*PI))
  // 37: 1 1 0 1 1 1   (2 != T) & (4 != A) & (6.2 != 2*T^(3J)) & (D != F) & (A  < PI) & (SIN (D*PI) < X)
  // 38: 1 1 0 1 0 1   (2 != T) & (4 != A) & (6.2 != 2*T^(3J)) & (D != F) & (A  < PI) & (X <= SIN(D*PI))
  // 39: 0 1 0 1 1 1   (2 != T) & (4 != A) & (6.2 != 2*T^(3J)) & (D != F) & (SIN (D*PI) < X) & (PI <= A)
  // 40: 0 1 0 1 0 1   (2 != T) & (4 != A) & (6.2 != 2*T^(3J)) & (D != F) & (PI <= A) & (X <= SIN(D*PI))
  //
  //
