...
pnorm(const T1 x, const T2 mu_par, const T3 sigma_par, const bool log_form = false) noexcept;
 ...
 *
 * Example:
 * \code{.cpp} stats::pnorm(1.0,false); \endcode
 */

template<typename T>
statslib_constexpr
return_t<T>
pnorm(const T x, const bool log_form = false) noexcept;
