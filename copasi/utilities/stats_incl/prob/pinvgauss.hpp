...
#ifndef _statslib_pinvgauss_HPP
#define _statslib_pinvgauss_HPP

//
// scalar input

/**
 * @brief Distribution function of the inverse Gaussian distribution
 *
 ...
 *
 * Example:
 * \code{.cpp} stats::pinvgauss(2.0,1.0,2.0,false); \endcode
 */

template<typename T1, typename T2, typename T3>
statslib_constexpr
common_return_t<T1,T2,T3>
pinvgauss(const T1 x, const T2 mu_par, const T3 lambda_par, const bool log_form = false) noexcept;
...
statslib_inline
std::vector<rT>
pinvgauss(const std::vector<eT>& x, const T1 mu_par, const T2 lambda_par, const bool log_form = false);
#endif
...
statslib_inline
ArmaMat<rT>
pinvgauss(const ArmaMat<eT>& X, const T1 mu_par, const T2 lambda_par, const bool log_form = false);
...
statslib_inline
mT
pinvgauss(const ArmaGen<mT,tT>& X, const T1 mu_par, const T2 lambda_par, const bool log_form = false);
#endif
...
statslib_inline
BlazeMat<rT,To>
pinvgauss(const BlazeMat<eT,To>& X, const T1 mu_par, const T2 lambda_par, const bool log_form = false);
#endif
...
statslib_inline
EigenMat<rT,iTr,iTc>
pinvgauss(const EigenMat<eT,iTr,iTc>& X, const T1 mu_par, const T2 lambda_par, const bool log_form = false);
#endif

//
// include implementation files

#include "pinvgauss.ipp"
