...
statslib_inline
mT
rpois(const ullint_t n, const ullint_t k, const T1 rate_par, rand_engine_t& engine);
...
statslib_inline
mT
rpois(const ullint_t n, const ullint_t k, const T1 rate_par, const ullint_t seed_val = std::random_device{}());
