...
ResultData::ResultData(const std::vector<FittingItem *> &fittingItems, const std::vector<CheckPoint *> &checkPoints, CCopasiDataModel *dataModel, bool isOptimization)
