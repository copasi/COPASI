...
void CMCAMethod::calculateUnscaledConcentrationCC()
{
 ...
 * @return Matrix
 */
CMatrix < C_FLOAT64 > CMCAMethod::getDxv()
{
  return mDxv;
}
 ...
 * @return Matrix
 */
CMatrix < C_FLOAT64 > CMCAMethod::getFcc()
{
  return mFcc;
}
 ...
 * @return Matrix
 */
CMatrix < C_FLOAT64 > CMCAMethod::getGamma()
{
  return mGamma;
}
 ...
 */
void CMCAMethod::CalcFCC(int condition)
{
  unsigned C_INT32 i, j, k;
