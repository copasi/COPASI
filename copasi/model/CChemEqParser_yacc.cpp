...
/* Line 216 of yacc.c.  */
#line 159 "CChemEqParser_yacc.cpp"
...
static const yytype_uint8 yyrline[] =
  {
    0, 46, 46, 49, 54, 57, 62, 66, 70, 77,
    86, 96, 105, 113, 121, 126, 134, 139, 145, 153
  };
#endif
...
#line 50 "CChemEqParser.ypp"
      {
        mReversibility = ((yyvsp[(2) - (3)])->name == "=") ? true : false;
        pdelete((yyvsp[(2) - (3)]));
      }
      break;
...
#line 58 "CChemEqParser.ypp"
      {
        mReversibility = ((yyvsp[(2) - (2)])->name == "=") ? true : false;
        pdelete((yyvsp[(2) - (2)]));
      }
      break;
...
#line 71 "CChemEqParser.ypp"
      {
        mSubstrateNames.push_back((yyvsp[(1) - (1)])->name);
        mSubstrateMult.push_back((yyvsp[(1) - (1)])->multiplicity);
        mSubstrateCompartments.push_back((yyvsp[(1) - (1)])->compartment);
        pdelete((yyvsp[(1) - (1)]));
      }
      break;
...
#line 78 "CChemEqParser.ypp"
      {
        mSubstrateNames.push_back((yyvsp[(3) - (3)])->name);
        mSubstrateMult.push_back((yyvsp[(3) - (3)])->multiplicity);
        mSubstrateCompartments.push_back((yyvsp[(3) - (3)])->compartment);
        pdelete((yyvsp[(2) - (3)]));
        pdelete((yyvsp[(3) - (3)]));
      }
      break;
...
#line 87 "CChemEqParser.ypp"
      {
        mReversibility = ((yyvsp[(1) - (2)])->name == "=") ? true : false;

        mProductNames.push_back((yyvsp[(2) - (2)])->name);
        mProductMult.push_back((yyvsp[(2) - (2)])->multiplicity);
        mProductCompartments.push_back((yyvsp[(2) - (2)])->compartment);
        pdelete((yyvsp[(1) - (2)]));
        pdelete((yyvsp[(2) - (2)]));
      }
      break;
...
#line 97 "CChemEqParser.ypp"
      {
        mProductNames.push_back((yyvsp[(3) - (3)])->name);
        mProductMult.push_back((yyvsp[(3) - (3)])->multiplicity);
        mProductCompartments.push_back((yyvsp[(3) - (3)])->compartment);
        pdelete((yyvsp[(2) - (3)]));
        pdelete((yyvsp[(3) - (3)]));
      }
      break;
...
#line 106 "CChemEqParser.ypp"
      {
        mModifierNames.push_back((yyvsp[(2) - (2)])->name);
        mModifierMult.push_back((yyvsp[(2) - (2)])->multiplicity);
        mModifierCompartments.push_back((yyvsp[(2) - (2)])->compartment);
        pdelete((yyvsp[(1) - (2)]));
        pdelete((yyvsp[(2) - (2)]));
      }
      break;
...
#line 127 "CChemEqParser.ypp"
      {
        (yyval) = (yyvsp[(1) - (2)]);
        (yyval)->compartment = (yyvsp[(2) - (2)])->name;
        pdelete((yyvsp[(2) - (2)]));
      }
      break;
...
#line 140 "CChemEqParser.ypp"
      {
        (yyval) = (yyvsp[(2) - (2)]);
        (yyval)->multiplicity = strtod((yyvsp[(1) - (2)])->name.c_str(), NULL);
        pdelete((yyvsp[(1) - (2)]));
      }
      break;
...
#line 146 "CChemEqParser.ypp"
      {
        (yyval) = (yyvsp[(3) - (3)]);
        (yyval)->multiplicity = strtod((yyvsp[(1) - (3)])->name.c_str(), NULL);
        pdelete((yyvsp[(1) - (3)]));
        pdelete((yyvsp[(2) - (3)]));
      }
      break;
...
#line 154 "CChemEqParser.ypp"
      ...
      /* Line 1267 of yacc.c.  */
#line 1521 "CChemEqParser_yacc.cpp"
    default: break;
    }
