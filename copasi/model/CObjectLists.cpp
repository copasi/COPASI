  ...
  switch (t)
    {
      ...
      case REDUCED_JACOBIAN_EV_RE:
      {
        ...
        const CDataArray * pEV = dynamic_cast<const CDataArray*>(pParent->getChildObject(CCommonName("Vector=TaskList[Steady-State],Array=Eigenvalues of reduced system Jacobian")));
