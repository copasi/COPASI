...
void CLSODA::enablePrint(const bool & print)
{mpxerrwd->enablePrint(print);}
...
L60:
  ...
  (*mpxerrwd)(msg, &c__60, &c__103, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  msg = "      may not be later.  Integration will proceed anyway.   ";
  (*mpxerrwd)(msg, &c__60, &c__103, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  msg = "      Length needed is LENRW = I1, while LRW = I2.";
  (*mpxerrwd)(msg, &c__50, &c__103, &c__0, &c__2, &lenrw, lrw, &c__0, &c_b76, &
              c_b76, (C_INT)60);
L65:
  ...
  (*mpxerrwd)(msg, &c__60, &c__104, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  msg = "      may not be later.  Integration will proceed anyway.   ";
  (*mpxerrwd)(msg, &c__60, &c__104, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  msg = "      Length needed is LENIW = I1, while LIW = I2.";
  (*mpxerrwd)(msg, &c__50, &c__104, &c__0, &c__2, &leniw, liw, &c__0, &c_b76, &
              c_b76, (C_INT)60);
L70:
...
L210:
  ...
  mpS->dintdy_(tout, &c__0, &rwork[dls001_1.lyh], &dls001_1.nyh, &y[1], &iflag);
  if (iflag != 0)
    {
      goto L627;
    }
...
L280:
  ...
  (*mpxerrwd)(msg, &c__50, &c__101, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  msg = "      such that in the machine, T + H = T on the next step  ";
  (*mpxerrwd)(msg, &c__60, &c__101, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  msg = "     (H = step size). Solver will continue anyway.";
  (*mpxerrwd)(msg, &c__50, &c__101, &c__0, &c__0, &c__0, &c__0, &c__2, &
  ...
  (*mpxerrwd)(msg, &c__50, &c__102, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  msg = "     It will not be issued again for this problem.";
  (*mpxerrwd)(msg, &c__50, &c__102, &c__0, &c__1, &dls001_1.mxhnil, &c__0, &
              c__0, &c_b76, &c_b76, (C_INT)60);
L290:
  /* ----------------------------------------------------------------------- */
  /*   CALL DSTODA(NEQ,Y,YH,NYH,YH,EWT,SAVF,ACOR,WM,IWM,F,JAC,DPRJA,DSOLSY) */
  /* ----------------------------------------------------------------------- */
  mpS->dstoda_(&neq[1], &y[1], &rwork[dls001_1.lyh], &dls001_1.nyh, &rwork[dls001_1.lyh], &rwork[dls001_1.lewt], &rwork[dls001_1.lsavf], &
  ...
  if (dls001_1.meth == 2)
    {
      ...
      (*mpxerrwd)(msg, &c__60, &c__105, &c__0, &c__0, &c__0, &c__0, &c__0, &
                  c_b76, &c_b76, (C_INT)60);
    }
  if (dls001_1.meth == 1)
    {
      msg = "DLSODA- A switch to the Adams (nonstiff) method has occ urred";
      (*mpxerrwd)(msg, &c__60, &c__106, &c__0, &c__0, &c__0, &c__0, &c__0, &
                  c_b76, &c_b76, (C_INT)60);
    }
  msg = "     at T = R1,  tentative step size H = R2,  step NST = I1 ";
  (*mpxerrwd)(msg, &c__60, &c__107, &c__0, &c__1, &dls001_1.nst, &c__0, &c__2, &
              dls001_1.tn, &dls001_1.h__, (C_INT)60);
L310:
  switch (*itask)
    {
...
L500:
  ...
  (*mpxerrwd)(msg, &c__50, &c__201, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  msg = "      taken on this call before reaching TOUT     ";
  (*mpxerrwd)(msg, &c__50, &c__201, &c__0, &c__1, &dls001_1.mxstep, &c__0, &
...
L510:
  ...
  (*mpxerrwd)(msg, &c__50, &c__202, &c__0, &c__1, &i__, &c__0, &c__2, &
...
L520:
  ...
  (*mpxerrwd)(msg, &c__50, &c__203, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  msg = "      for precision of machine..  See TOLSF (=R2) ";
  (*mpxerrwd)(msg, &c__50, &c__203, &c__0, &c__0, &c__0, &c__0, &c__2, &
...
L530:
  ...
  (*mpxerrwd)(msg, &c__50, &c__204, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  msg = "      test failed repeatedly or with ABS(H) = HMIN";
  (*mpxerrwd)(msg, &c__50, &c__204, &c__0, &c__0, &c__0, &c__0, &c__2, &
              dls001_1.tn, &dls001_1.h__, (C_INT)60);
  *istate = -4;
  goto L560;
...
L540:
  ...
  (*mpxerrwd)(msg, &c__50, &c__205, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  msg = "      corrector convergence failed repeatedly     ";
  (*mpxerrwd)(msg, &c__50, &c__205, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  msg = "      or with ABS(H) = HMIN   ";
  (*mpxerrwd)(msg, &c__30, &c__205, &c__0, &c__0, &c__0, &c__0, &c__2, &
              dls001_1.tn, &dls001_1.h__, (C_INT)60);
  *istate = -5;
  goto L560;
...
L550:
  ...
  (*mpxerrwd)(msg, &c__50, &c__206, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  msg = "      to proceed.  The integration was otherwise successful.";
  (*mpxerrwd)(msg, &c__60, &c__206, &c__0, &c__0, &c__0, &c__0, &c__1, &
...
L555:
  ...
  (*mpxerrwd)(msg, &c__50, &c__207, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  msg = "      to proceed.  The integration was otherwise successful.";
  (*mpxerrwd)(msg, &c__60, &c__207, &c__0, &c__0, &c__0, &c__0, &c__1, &
              dls001_1.tn, &c_b76, (C_INT)60);
  *istate = -7;
  goto L580;
...
L601:
  ...
  (*mpxerrwd)(msg, &c__30, &c__1, &c__0, &c__1, istate, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  if (*istate < 0)
    {
      goto L800;
...
L602:
  ...
  (*mpxerrwd)(msg, &c__30, &c__2, &c__0, &c__1, itask, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  goto L700;
L603:
  msg = "DLSODA-  ISTATE .gt. 1 but DLSODA not initialized.";
  (*mpxerrwd)(msg, &c__50, &c__3, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  goto L700;
L604:
  msg = "DLSODA-  NEQ (=I1) .lt. 1     ";
  (*mpxerrwd)(msg, &c__30, &c__4, &c__0, &c__1, &neq[1], &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  goto L700;
L605:
  msg = "DLSODA-  ISTATE = 3 and NEQ increased (I1 to I2). ";
  (*mpxerrwd)(msg, &c__50, &c__5, &c__0, &c__2, &dls001_1.n, &neq[1], &c__0, &
              c_b76, &c_b76, (C_INT)60);
  goto L700;
L606:
  msg = "DLSODA-  ITOL (=I1) illegal.  ";
  (*mpxerrwd)(msg, &c__30, &c__6, &c__0, &c__1, itol, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  goto L700;
L607:
  msg = "DLSODA-  IOPT (=I1) illegal.  ";
  (*mpxerrwd)(msg, &c__30, &c__7, &c__0, &c__1, iopt, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  goto L700;
L608:
  msg = "DLSODA-  JT (=I1) illegal.    ";
  (*mpxerrwd)(msg, &c__30, &c__8, &c__0, &c__1, jt, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  goto L700;
L609:
  msg = "DLSODA-  ML (=I1) illegal: .lt.0 or .ge.NEQ (=I2) ";
  (*mpxerrwd)(msg, &c__50, &c__9, &c__0, &c__2, &ml, &neq[1], &c__0, &c_b76, &
              c_b76, (C_INT)60);
  goto L700;
L610:
  msg = "DLSODA-  MU (=I1) illegal: .lt.0 or .ge.NEQ (=I2) ";
  (*mpxerrwd)(msg, &c__50, &c__10, &c__0, &c__2, &mu, &neq[1], &c__0, &c_b76, &
              c_b76, (C_INT)60);
  goto L700;
L611:
  msg = "DLSODA-  IXPR (=I1) illegal.  ";
  (*mpxerrwd)(msg, &c__30, &c__11, &c__0, &c__1, &dlsa01_1.ixpr, &c__0, &c__0, &
              c_b76, &c_b76, (C_INT)60);
  goto L700;
L612:
  msg = "DLSODA-  MXSTEP (=I1) .lt. 0  ";
  (*mpxerrwd)(msg, &c__30, &c__12, &c__0, &c__1, &dls001_1.mxstep, &c__0, &c__0,
              &c_b76, &c_b76, (C_INT)60);
  goto L700;
L613:
  msg = "DLSODA-  MXHNIL (=I1) .lt. 0  ";
  (*mpxerrwd)(msg, &c__30, &c__13, &c__0, &c__1, &dls001_1.mxhnil, &c__0, &c__0,
              &c_b76, &c_b76, (C_INT)60);
  goto L700;
L614:
  msg = "DLSODA-  TOUT (=R1) behind T (=R2)      ";
  (*mpxerrwd)(msg, &c__40, &c__14, &c__0, &c__0, &c__0, &c__0, &c__2, tout, t, (
                C_INT)60);
  msg = "      Integration direction is given by H0 (=R1)  ";
  (*mpxerrwd)(msg, &c__50, &c__14, &c__0, &c__0, &c__0, &c__0, &c__1, &h0, &
              c_b76, (C_INT)60);
  goto L700;
L615:
  msg = "DLSODA-  HMAX (=R1) .lt. 0.0  ";
  (*mpxerrwd)(msg, &c__30, &c__15, &c__0, &c__0, &c__0, &c__0, &c__1, &hmax, &
              c_b76, (C_INT)60);
  goto L700;
L616:
  msg = "DLSODA-  HMIN (=R1) .lt. 0.0  ";
  (*mpxerrwd)(msg, &c__30, &c__16, &c__0, &c__0, &c__0, &c__0, &c__1, &
              dls001_1.hmin, &c_b76, (C_INT)60);
  goto L700;
L617:
  msg = "DLSODA-  RWORK length needed, LENRW (=I1), exceeds LRW (=I2)";
  (*mpxerrwd)(msg, &c__60, &c__17, &c__0, &c__2, &lenrw, lrw, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  goto L700;
L618:
  msg = "DLSODA-  IWORK length needed, LENIW (=I1), exceeds LIW (=I2)";
  (*mpxerrwd)(msg, &c__60, &c__18, &c__0, &c__2, &leniw, liw, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  goto L700;
L619:
  msg = "DLSODA-  RTOL(I1) is R1 .lt. 0.0        ";
  (*mpxerrwd)(msg, &c__40, &c__19, &c__0, &c__1, &i__, &c__0, &c__1, &rtoli, &
              c_b76, (C_INT)60);
  goto L700;
L620:
  msg = "DLSODA-  ATOL(I1) is R1 .lt. 0.0        ";
  (*mpxerrwd)(msg, &c__40, &c__20, &c__0, &c__1, &i__, &c__0, &c__1, &atoli, &
              c_b76, (C_INT)60);
  goto L700;
L621:
  ewti = rwork[dls001_1.lewt + i__ - 1];
  msg = "DLSODA-  EWT(I1) is R1 .le. 0.0         ";
  (*mpxerrwd)(msg, &c__40, &c__21, &c__0, &c__1, &i__, &c__0, &c__1, &ewti, &
              c_b76, (C_INT)60);
  goto L700;
L622:
  msg = "DLSODA-  TOUT(=R1) too close to T(=R2) to start integration.";
  (*mpxerrwd)(msg, &c__60, &c__22, &c__0, &c__0, &c__0, &c__0, &c__2, tout, t,
              (C_INT)60);
  goto L700;
L623:
  msg = "DLSODA-  ITASK = I1 and TOUT (=R1) behind TCUR - HU (= R2)  ";
  (*mpxerrwd)(msg, &c__60, &c__23, &c__0, &c__1, itask, &c__0, &c__2, tout, &tp,
              (C_INT)60);
  goto L700;
L624:
  msg = "DLSODA-  ITASK = 4 or 5 and TCRIT (=R1) behind TCUR (=R2)   ";
  (*mpxerrwd)(msg, &c__60, &c__24, &c__0, &c__0, &c__0, &c__0, &c__2, &tcrit, &
              dls001_1.tn, (C_INT)60);
  goto L700;
L625:
  msg = "DLSODA-  ITASK = 4 or 5 and TCRIT (=R1) behind TOUT (=R2)   ";
  (*mpxerrwd)(msg, &c__60, &c__25, &c__0, &c__0, &c__0, &c__0, &c__2, &tcrit,
              tout, (C_INT)60);
  goto L700;
L626:
  msg = "DLSODA-  At start of problem, too much accuracy   ";
  (*mpxerrwd)(msg, &c__50, &c__26, &c__0, &c__0, &c__0, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  msg = "      requested for precision of machine..  See TOLSF (=R1) ";
  (*mpxerrwd)(msg, &c__60, &c__26, &c__0, &c__0, &c__0, &c__0, &c__1, &tolsf, &
              c_b76, (C_INT)60);
  rwork[14] = tolsf;
  goto L700;
L627:
  msg = "DLSODA-  Trouble in DINTDY.  ITASK = I1, TOUT = R1";
  (*mpxerrwd)(msg, &c__50, &c__27, &c__0, &c__1, itask, &c__0, &c__1, tout, &
              c_b76, (C_INT)60);
  goto L700;
L628:
  msg = "DLSODA-  MXORDN (=I1) .lt. 0  ";
  (*mpxerrwd)(msg, &c__30, &c__28, &c__0, &c__1, &dlsa01_1.mxordn, &c__0, &c__0,
              &c_b76, &c_b76, (C_INT)60);
  goto L700;
L629:
  msg = "DLSODA-  MXORDS (=I1) .lt. 0  ";
  (*mpxerrwd)(msg, &c__30, &c__29, &c__0, &c__1, &dlsa01_1.mxords, &c__0, &c__0,
              &c_b76, &c_b76, (C_INT)60);
...
L800:
  ...
  (*mpxerrwd)(msg, &c__50, &c__303, &c__2, &c__0, &c__0, &c__0, &c__0, &c_b76, &
              c_b76, (C_INT)60);
  return 0;
