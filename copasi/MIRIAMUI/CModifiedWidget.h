// Begin CVS Header
//   $Source: /Volumes/Home/Users/shoops/cvs/copasi_dev/copasi/MIRIAMUI/Attic/CModifiedWidget.h,v $
//   $Revision: 1.3 $
//   $Name:  $
//   $Author: shoops $
...
#ifndef COPASI_CMODIFIEDWIDGET
#define COPASI_CMODIFIEDWIDGET

#include <vector>
#include "UI/CopasiTableWidget.h"

class CModifiedWidget : public CopasiTableWidget
  {
    Q_OBJECT
  public:
    CModifiedWidget(QWidget *parent, const char * name = 0, Qt::WFlags f = 0);
    ~CModifiedWidget();
    /**
