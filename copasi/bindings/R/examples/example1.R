...
CReaction_setParameterMapping(reaction,0, CCopasiObject_getKey(modelValue))
# now we have to set the parameter mapping for the substrates
CReaction_addParameterMapping(reaction,"substrate", CCopasiObject_getKey(g6p))
CReaction_addParameterMapping(reaction,"substrate", CCopasiObject_getKey(adp))
...
CCopasiDataModel_saveModel(dataModel,"example1.cps", TRUE)
