...
object <- glucose$getChildObject(CCommonName("Reference=InitialConcentration"))
stopifnot(!is.null(object))
invisible(changedObjects$push_back(object))
...
object <- g6p$getChildObject(CCommonName("Reference=InitialConcentration"))
stopifnot(!is.null(object))
invisible(changedObjects$push_back(object))
...
object <- atp$getChildObject(CCommonName("Reference=InitialConcentration"))
stopifnot(!is.null(object))
invisible(changedObjects$push_back(object))
...
object <- adp$getChildObject(CCommonName("Reference=InitialConcentration"))
stopifnot(!is.null(object))
invisible(changedObjects$push_back(object))
...
if (!is.null(fun)){
    ...
    object <- parameter$getChildObject(CCommonName("Reference=Value"))
    stopifnot(!is.null(object))
    invisible(changedObjects$push_back(object))
} else{
...
object <- modelValue$getChildObject(CCommonName("Reference=InitialValue"))
stopifnot(!is.null(object))
invisible(changedObjects$push_back(object))
