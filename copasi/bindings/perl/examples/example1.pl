...
####    unless(reaction.isReversible() == False){warn "Assertion failed";die;}
...
####    unless(len(suitableFunctions) > 0){warn "Assertion failed";die;}
####    my function = '';
...
####        unless(len(reaction.getParameterMappings()) == 1){warn "Assertion failed";die;}
...
####    unless(len(reaction.getParameterMappings()) == 2){warn "Assertion failed";die;}
