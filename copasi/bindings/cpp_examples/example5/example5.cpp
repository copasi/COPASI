...
int main()
{
  ...
  pOptProblem->setModel(CCopasiDataModel::Global->getModel());
  ...
  pTimeCourseTask->getProblem()->setModel(CCopasiDataModel::Global->getModel());
  ...
  try
    {
      ...
      pOptTask->initialize(CCopasiTask::OUTPUT_COMPLETE, CCopasiDataModel::Global, NULL);
