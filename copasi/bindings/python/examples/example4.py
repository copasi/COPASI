...
def main(args):
   ...
   scanTask = CCopasiDataModel.GLOBAL.getTask("Scan")
   ...
   if scanTask == None:
       ...
       # this method makes sure the object is now owned by the list
       # and that SWIG does not delete it
       CCopasiDataModel.GLOBAL.getTaskList().addAndOwn(scanTask)
   ...
   scanProblem.setModel(CCopasiDataModel.GLOBAL.getModel())
