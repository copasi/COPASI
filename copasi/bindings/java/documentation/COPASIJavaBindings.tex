...
The class \texit{CEigen} class provides several methods to determine the charcteristics of the Eigenvalues.

\begin{lstlisting}
/**
 * Returns the largest real part in all Eignevalues.
 */
public double getMaxrealpart();

/**
 * Returns the largest imaginary part in all Eignevalues.
 */
