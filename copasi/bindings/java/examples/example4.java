...
class example4
{
    public static void main(String[] args)
    {
        ...
        body.add(new CRegisteredObjectName(new CCopasiObjectName(CCopasiDataModel.getGlobal().getModel().getCN().getString() + ",Reference=Time").getString()));
        ...
        CScanTask scanTask = (CScanTask)CCopasiDataModel.getGlobal().getTask("Scan");
        ...
        if (scanTask == null)
        {
            ...
            // this method makes sure that the object is now owned 
            // by the list and that it does not get deleted by SWIG
            CCopasiDataModel.getGlobal().getTaskList().addAndOwn(scanTask);
        }
        ...
        scanProblem.setModel(CCopasiDataModel.getGlobal().getModel());
