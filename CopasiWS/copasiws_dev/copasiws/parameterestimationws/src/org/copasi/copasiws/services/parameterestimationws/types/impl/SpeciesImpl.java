// Begin CVS Header 
//   $Source: /Volumes/Home/Users/shoops/cvs/copasi_dev/CopasiWS/copasiws_dev/copasiws/parameterestimationws/src/org/copasi/copasiws/services/parameterestimationws/types/impl/SpeciesImpl.java,v $ 
//   $Revision: 1.1 $ 
//   $Name:  $ 
//   $Author: jdada $ 
 ...
 */
public class SpeciesImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl
    implements org.copasi.copasiws.services.parameterestimationws.types.Species {
     ...
     */
    public org.copasi.copasiws.services.parameterestimationws.types.Species.QuantityType.Enum getQuantityType() {
        synchronized (monitor()) {
            check_orphaned();
            ...
            return (org.copasi.copasiws.services.parameterestimationws.types.Species.QuantityType.Enum) target.getEnumValue();
        }
    }
     ...
     */
    public org.copasi.copasiws.services.parameterestimationws.types.Species.QuantityType xgetQuantityType() {
        synchronized (monitor()) {
            check_orphaned();

            org.copasi.copasiws.services.parameterestimationws.types.Species.QuantityType target =
                null;
            target = (org.copasi.copasiws.services.parameterestimationws.types.Species.QuantityType) get_store()
                                                                                                         .find_attribute_user(QUANTITYTYPE$2);
    ...
    public static class QuantityTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx
        implements org.copasi.copasiws.services.parameterestimationws.types.Species.QuantityType {
