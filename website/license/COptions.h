...
/**
 * This is the main header file (COptions.h).
...
#ifndef LICENSE_COptions
#define LICENSE_COptions
...
namespace license
  ...
  /**
   * the COptions class is the main command
  ...
  class COptions
    ...
    }  ; // end license::COptions class
} // end license namespace
#endif // LICENSE_COptions
