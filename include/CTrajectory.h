...
public:
	 ...
	 */	
	CTrajectory(CModel * aModel, C_INT32 aPoints, C_INT32 aN,
	 ...
	 */
	CTrajectory(CTrajectory& source);
	 ...
	 */
	CTrajectory& operator=(CTrajectory& source);
	 ...
	 *  @return mODESolver
	 */	
	CODESolver * GetSolver();

	/*
	 * Set the time points
	 * @param anInt an int passed to be set as mPoints
	 */
	void SetPoints(C_INT32 anInt);
