...
if(BLAS_FOUND AND APPLE)
  list(APPEND LOCAL_LAPACK_DEFINES "-DHAVE_APPLE")
...
if(NOT LAPACK_FOUND)
  ...
  if(DEFINED MKLROOT)
    ...
    list(APPEND LOCAL_LAPACK_DEFINES "-DHAVE_MKL")
...
if(NOT LAPACK_FOUND AND DEFINED ENV{LAPACK_DIR} AND EXISTS $ENV{LAPACK_DIR})
  ...
  list(APPEND LOCAL_LAPACK_DEFINES "-DHAVE_BLASWRAP_H")
  list(APPEND LOCAL_LAPACK_DEFINES "-DHAVE_F2C_H")
  list(APPEND LOCAL_LAPACK_DEFINES "-DHAVE_CLAPACK_H")
  list(APPEND LOCAL_LAPACK_DEFINES "-DNO_BLAS_WRAP")
...
if(NOT LAPACK_FOUND AND LINUX)
  ...
  if(NOT CLAPACK_INCLUDE_DIR)
    ...
    if(CLAPACK_INCLUDE_DIR)
      list(APPEND LOCAL_LAPACK_DEFINES "-DHAVE_LAPACK_H")
    endif(CLAPACK_INCLUDE_DIR)
  endif(NOT CLAPACK_INCLUDE_DIR)
endif()
...
if(BLAS_INCLUDE_DIR)
  list(APPEND LOCAL_LAPACK_DEFINES "-DHAVE_BLAS_H")
...
if(LAPACKWRAP_INCLUDE_DIR)
  list(APPEND LOCAL_LAPACK_DEFINES "-DHAVE_LAPACKWRAP_H")
