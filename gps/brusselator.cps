...
<!-- generated with COPASI 4.0 Debug 15++ (http://www.copasi.org) at 2005-12-14 17:05:56 UTC -->
...
<p>The famous Brusselator model in which a chemical species X catalyses its own formation. In a certain region of parameter space the Brusselator can function in a limit cycle regime around an unstable steady state. Run this simulation and then check the report file to see how Gepasi can find an unstable steady state, and calculate the eigenvalues of the Jacobian matrix.</p>
    ...
    <ListOfReactions>
      ...
      <Reaction key="Reaction_3" name="R4" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_48" name="k1" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_10" name="Parameter Fitting" type="parameterFitting" scheduled="false" updateModel="false">
      <Problem>
  ...
  <ListOfReports>
    <Report key="Report_3" name="Steady-State" taskType="steadyState" separator="&#x09;">
      <Comment>
    ...
    <Report key="Report_5" name="Parameter Fitting" taskType="parameterFitting" separator="&#x09;">
      <Comment>
        <body xmlns="http://www.w3.org/1999/xhtml">
          Automatically generated report.
        </body>
