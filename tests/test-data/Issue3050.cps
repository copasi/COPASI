...
<!-- generated with COPASI 4.34 (Build 251) (http://www.copasi.org) at 2021-10-01T10:19:52Z -->
...
<rdf:Description rdf:about="#ModelParameterSet_1">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[x]" value="1" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[y]" value="1" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[f]" value="45" type="ModelValue" simulationType="assignment"/>
        </ModelParameterGroup>
  ...
  <ListOfTasks>
    ...
    <Task key="Task_19" name="Scan" type="scan" scheduled="false" updateModel="true">
      <Problem>
    ...
    <Task key="Task_21" name="Optimization" type="optimization" scheduled="true" updateModel="true">
      <Report reference="Report_20" target="../../../../Downloads/test" append="1" confirmOverwrite="0"/>
      <Problem>
  ...
  <ListOfReports>
    ...
    <Report key="Report_20" name="Empty" taskType="unset" separator="&#x09;" precision="6">
      <Comment>
  ...
  <ListOfPlots>
    <PlotSpecification name="Progress of Optimization" type="Plot2D" active="0" taskTypes="Optimization">
    ...
    <PlotSpecification name="contour" type="Plot2D" active="1" taskTypes="Scan">
      <Parameter name="log X" type="bool" value="0"/>
