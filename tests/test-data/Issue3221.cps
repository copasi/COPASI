...
<!-- generated with COPASI 4.42 (Build 284) (http://www.copasi.org) at 2024-03-14T19:03:26Z -->
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_0">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2024-03-13T13:35:38Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
    <dcterms:creator>
      <rdf:Description>
...
<rdf:Description rdf:about="#Compartment_2">
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_6" name="B" simulationType="reactions" compartment="Compartment_2" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Metabolite_6">
      ...
      <Metabolite key="Metabolite_7" name="a" simulationType="reactions" compartment="Compartment_2" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Metabolite_7">
      ...
      <Metabolite key="Metabolite_5" name="c" simulationType="ode" compartment="Compartment_2" addNoise="false">
        <Expression>
          2*&lt;CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[a],Reference=Concentration>*&lt;CN=Root,Model=New Model,Vector=Values[c],Reference=Value>/&lt;CN=Root,Model=New Model,Vector=Values[d],Reference=InitialValue>
        </Expression>
      </Metabolite>
    </ListOfMetabolites>
    <ListOfModelValues>
      <ModelValue key="ModelValue_10" name="c" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#ModelParameterSet_0">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[B]" value="6.0221407599999952e+23" type="Species" simulationType="reactions"/>
          ...
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[c]" value="6.0221407599999958e+23" type="Species" simulationType="ode"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[c]" value="1" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[d]" value="3" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
    ...
    <InitialState type="initialState">
      0 6.0221407599999958e+23 6.0221407599999952e+23 6.0221407599999952e+23 1 1 3 
    </InitialState>
  </Model>
  <ListOfTasks>
